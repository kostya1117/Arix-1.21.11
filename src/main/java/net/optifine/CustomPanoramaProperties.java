...
public class CustomPanoramaProperties {
    private String path;
    private Identifier[] panoramaLocations;
    ...
    public CustomPanoramaProperties(String path, Properties props) {
        ...
        this.path = path;
        this.panoramaLocations = new Identifier[6];

        for (int i = 0; i < this.panoramaLocations.length; i++) {
            this.panoramaLocations[i] = new Identifier(path + "/panorama_" + i + ".png");
        }
    ...
    public Identifier[] getPanoramaLocations() {
