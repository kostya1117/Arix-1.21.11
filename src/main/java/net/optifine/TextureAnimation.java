...
public class TextureAnimation {
    ...
    public TextureAnimation(
        String texFrom, byte[] srcData, String texTo, Identifier locTexTo, int dstX, int dstY, int frameWidth, int frameHeight, Properties props
    ) {
        this.srcTex = texFrom;
        this.dstTex = texTo;
    ...
    public void updateTexture() {
        if (this.valid) {
            if (this.dstTextId < 0) {
                ...
                this.dstTextId = abstracttexture.getGlTextureId();
            }
                    ...
                    if (textureanimationframe != null) {
                        ...
                        if (i + j <= this.imageData.limit()) {
                            if (!this.interpolate || textureanimationframe.counter <= 0) {
                                ...
                                double d0 = 1.0 * textureanimationframe.counter / textureanimationframe.duration;
    ...
    public Identifier getDstTexLoc() {
