...
public class ModelSprite {
    ...
    public static void renderItemIn2D(
        ...
        float f7 = 0.5F * f / sizeX;
        float f8 = 0.5F * f1 / sizeY;
        f4 = -1.0F;
        f5 = 0.0F;
        f6 = 0.0F;

        for (int i = 0; i < sizeX; i++) {
            float f9 = (float)i / sizeX;
        ...
        for (int j = 0; j < sizeX; j++) {
            float f12 = (float)j / sizeX;
            float f15 = minU + f * f12 + f7;
            float f11 = f12 + 1.0F / sizeX;
        ...
        for (int k = 0; k < sizeY; k++) {
            float f13 = (float)k / sizeY;
            float f16 = minV + f1 * f13 + f8;
            float f18 = f13 + 1.0F / sizeY;
