...
public class ConnectedTextures {
    ...
    public static Identifier LOCATION_SPRITE_EMPTY = TextureUtils.LOCATION_SPRITE_EMPTY;
    ...
    public static final TextureAtlasSprite SPRITE_DEFAULT = new TextureAtlasSprite(TextureAtlas.LOCATION_BLOCKS, new Identifier("default"));

    public static BakedQuad[] getConnectedTexture(
        BlockAndTintGetter blockAccess, BlockState blockState, BlockPos blockPos, BakedQuad quad, Direction facing, RenderEnv renderEnv
    ) {
        ...
        if (textureatlassprite == null) {
            ...
            return getConnectedTextureMultiPass(blockAccess, blockState, blockPos, facing, quad, renderEnv);
        }
    }
    ...
    private static boolean skipConnectedTexture(BlockGetter blockAccess, BlockState blockState, BlockPos blockPos, BakedQuad quad, RenderEnv renderEnv) {
        ...
        if (block instanceof IronBarsBlock) {
            ...
            BlockPos blockpos = blockPos.relative(quad.direction());
    ...
    private static synchronized BakedQuad getQuadFull(TextureAtlasSprite sprite, BakedQuad quadIn, int tintIndex) {
        ...
        if (i >= 0 && i < spriteQuadFullMaps.length) {
            ...
            Direction direction = quadIn.direction();
    ...
    private static BakedQuad makeSpriteQuad(BakedQuad quad, TextureAtlasSprite sprite) {
        return BakedQuadRetextured.make(quad, sprite);
    }
    ...
    private static BakedQuad[] getConnectedTextureOverlayCtm(
        ...
        try {
            TextureAtlasSprite textureatlassprite = getConnectedTextureCtm(
                cp, blockAccess, blockState, blockPos, vertAxis, side, quad.sprite(), metadata, renderEnv
            );
            if (textureatlassprite != null) {
                listquadsoverlay.addQuad(getQuadFull(textureatlassprite, quad, cp.tintIndex), cp.tintBlockState);
            }
    ...
    private static int getConnectedTextureCtmIndex(
        ...
        switch (side) {
            case 0:
                aboolean1[0] = !isNeighbour(cp, blockAccess, blockState, blockPos.east().north(), side, icon, metadata);
                aboolean1[1] = !isNeighbour(cp, blockAccess, blockState, blockPos.west().north(), side, icon, metadata);
                aboolean1[2] = !isNeighbour(cp, blockAccess, blockState, blockPos.east().south(), side, icon, metadata);
                aboolean1[3] = !isNeighbour(cp, blockAccess, blockState, blockPos.west().south(), side, icon, metadata);
                if (cp.innerSeams) {
                    BlockPos blockpos11 = blockPos.below();
                    aboolean1[0] = aboolean1[0] || isNeighbour(cp, blockAccess, blockState, blockpos11.east().north(), side, icon, metadata);
                    aboolean1[1] = aboolean1[1] || isNeighbour(cp, blockAccess, blockState, blockpos11.west().north(), side, icon, metadata);
                    aboolean1[2] = aboolean1[2] || isNeighbour(cp, blockAccess, blockState, blockpos11.east().south(), side, icon, metadata);
                    aboolean1[3] = aboolean1[3] || isNeighbour(cp, blockAccess, blockState, blockpos11.west().south(), side, icon, metadata);
                }
                break;
            case 1:
                aboolean1[0] = !isNeighbour(cp, blockAccess, blockState, blockPos.east().south(), side, icon, metadata);
                aboolean1[1] = !isNeighbour(cp, blockAccess, blockState, blockPos.west().south(), side, icon, metadata);
                aboolean1[2] = !isNeighbour(cp, blockAccess, blockState, blockPos.east().north(), side, icon, metadata);
                aboolean1[3] = !isNeighbour(cp, blockAccess, blockState, blockPos.west().north(), side, icon, metadata);
                if (cp.innerSeams) {
                    BlockPos blockpos10 = blockPos.above();
                    aboolean1[0] = aboolean1[0] || isNeighbour(cp, blockAccess, blockState, blockpos10.east().south(), side, icon, metadata);
                    aboolean1[1] = aboolean1[1] || isNeighbour(cp, blockAccess, blockState, blockpos10.west().south(), side, icon, metadata);
                    aboolean1[2] = aboolean1[2] || isNeighbour(cp, blockAccess, blockState, blockpos10.east().north(), side, icon, metadata);
                    aboolean1[3] = aboolean1[3] || isNeighbour(cp, blockAccess, blockState, blockpos10.west().north(), side, icon, metadata);
                }
                break;
            case 2:
                aboolean1[0] = !isNeighbour(cp, blockAccess, blockState, blockPos.west().below(), side, icon, metadata);
                aboolean1[1] = !isNeighbour(cp, blockAccess, blockState, blockPos.east().below(), side, icon, metadata);
                aboolean1[2] = !isNeighbour(cp, blockAccess, blockState, blockPos.west().above(), side, icon, metadata);
                aboolean1[3] = !isNeighbour(cp, blockAccess, blockState, blockPos.east().above(), side, icon, metadata);
                if (cp.innerSeams) {
                    BlockPos blockpos9 = blockPos.north();
                    aboolean1[0] = aboolean1[0] || isNeighbour(cp, blockAccess, blockState, blockpos9.west().below(), side, icon, metadata);
                    aboolean1[1] = aboolean1[1] || isNeighbour(cp, blockAccess, blockState, blockpos9.east().below(), side, icon, metadata);
                    aboolean1[2] = aboolean1[2] || isNeighbour(cp, blockAccess, blockState, blockpos9.west().above(), side, icon, metadata);
                    aboolean1[3] = aboolean1[3] || isNeighbour(cp, blockAccess, blockState, blockpos9.east().above(), side, icon, metadata);
                }
                break;
            case 3:
                aboolean1[0] = !isNeighbour(cp, blockAccess, blockState, blockPos.east().below(), side, icon, metadata);
                aboolean1[1] = !isNeighbour(cp, blockAccess, blockState, blockPos.west().below(), side, icon, metadata);
                aboolean1[2] = !isNeighbour(cp, blockAccess, blockState, blockPos.east().above(), side, icon, metadata);
                aboolean1[3] = !isNeighbour(cp, blockAccess, blockState, blockPos.west().above(), side, icon, metadata);
                if (cp.innerSeams) {
                    BlockPos blockpos8 = blockPos.south();
                    aboolean1[0] = aboolean1[0] || isNeighbour(cp, blockAccess, blockState, blockpos8.east().below(), side, icon, metadata);
                    aboolean1[1] = aboolean1[1] || isNeighbour(cp, blockAccess, blockState, blockpos8.west().below(), side, icon, metadata);
                    aboolean1[2] = aboolean1[2] || isNeighbour(cp, blockAccess, blockState, blockpos8.east().above(), side, icon, metadata);
                    aboolean1[3] = aboolean1[3] || isNeighbour(cp, blockAccess, blockState, blockpos8.west().above(), side, icon, metadata);
                }
                break;
            case 4:
                aboolean1[0] = !isNeighbour(cp, blockAccess, blockState, blockPos.below().south(), side, icon, metadata);
                aboolean1[1] = !isNeighbour(cp, blockAccess, blockState, blockPos.below().north(), side, icon, metadata);
                aboolean1[2] = !isNeighbour(cp, blockAccess, blockState, blockPos.above().south(), side, icon, metadata);
                aboolean1[3] = !isNeighbour(cp, blockAccess, blockState, blockPos.above().north(), side, icon, metadata);
                if (cp.innerSeams) {
                    BlockPos blockpos7 = blockPos.west();
                    aboolean1[0] = aboolean1[0] || isNeighbour(cp, blockAccess, blockState, blockpos7.below().south(), side, icon, metadata);
                    aboolean1[1] = aboolean1[1] || isNeighbour(cp, blockAccess, blockState, blockpos7.below().north(), side, icon, metadata);
                    aboolean1[2] = aboolean1[2] || isNeighbour(cp, blockAccess, blockState, blockpos7.above().south(), side, icon, metadata);
                    aboolean1[3] = aboolean1[3] || isNeighbour(cp, blockAccess, blockState, blockpos7.above().north(), side, icon, metadata);
                }
                break;
            case 5:
                aboolean1[0] = !isNeighbour(cp, blockAccess, blockState, blockPos.below().north(), side, icon, metadata);
                aboolean1[1] = !isNeighbour(cp, blockAccess, blockState, blockPos.below().south(), side, icon, metadata);
                aboolean1[2] = !isNeighbour(cp, blockAccess, blockState, blockPos.above().north(), side, icon, metadata);
                aboolean1[3] = !isNeighbour(cp, blockAccess, blockState, blockPos.above().south(), side, icon, metadata);
                if (cp.innerSeams) {
                    BlockPos blockpos1 = blockPos.east();
                    aboolean1[0] = aboolean1[0] || isNeighbour(cp, blockAccess, blockState, blockpos1.below().north(), side, icon, metadata);
                    aboolean1[1] = aboolean1[1] || isNeighbour(cp, blockAccess, blockState, blockpos1.below().south(), side, icon, metadata);
                    aboolean1[2] = aboolean1[2] || isNeighbour(cp, blockAccess, blockState, blockpos1.above().north(), side, icon, metadata);
                    aboolean1[3] = aboolean1[3] || isNeighbour(cp, blockAccess, blockState, blockpos1.above().south(), side, icon, metadata);
                }
        }

        if (i == 13 && aboolean1[0]) {
            i = 4;
        } else if (i == 15 && aboolean1[1]) {
            i = 5;
        } else if (i == 37 && aboolean1[2]) {
            i = 16;
        } else if (i == 39 && aboolean1[3]) {
            i = 17;
        } else if (i == 14 && aboolean1[0] && aboolean1[1]) {
            i = 7;
        } else if (i == 25 && aboolean1[0] && aboolean1[2]) {
            i = 6;
        } else if (i == 27 && aboolean1[3] && aboolean1[1]) {
            i = 19;
        } else if (i == 38 && aboolean1[3] && aboolean1[2]) {
            i = 18;
        } else if (i == 14 && !aboolean1[0] && aboolean1[1]) {
            i = 31;
        } else if (i == 25 && aboolean1[0] && !aboolean1[2]) {
            ...
            i = 42;
        } else if (i == 26 && aboolean1[0] && aboolean1[1] && aboolean1[2] && aboolean1[3]) {
            i = 46;
        } else if (i == 26 && !aboolean1[0] && aboolean1[1] && aboolean1[2] && aboolean1[3]) {
            i = 9;
        } else if (i == 26 && aboolean1[0] && !aboolean1[1] && aboolean1[2] && aboolean1[3]) {
    ...
    private static TextureAtlasSprite getNeighbourIcon(BlockGetter worldReader, BlockState blockState, BlockPos blockPos, BlockState neighbourState, int side) {
        BlockModelPart blockmodelpart = BlockModelUtils.getModel(neighbourState);
        ...
        if (list.size() > 0) {
            ...
            return bakedquad1.sprite();
        }

        List list1 = blockmodelpart.getQuads(null);
        if (list1 == null) {
            return null;
        }
    ...
    private static TextureAtlasSprite getSprite(TextureAtlas textureMap, Identifier loc) {
    ...
    private static void addToTileList(ConnectedProperties cp, List tileList) {
        if (cp.matchTileIcons != null) {
            for (int i = 0; i < cp.matchTileIcons.length; i++) {
                ...
                if (!(textureatlassprite instanceof TextureAtlasSprite textureatlassprite1)) {
                    Config.warn("TextureAtlasSprite is not TextureAtlasSprite: " + textureatlassprite + ", name: " + textureatlassprite.getName());
                } else {
                    int j = textureatlassprite1.getIndexInMap();
                    if (j < 0) {
                        Config.warn("Invalid tile ID: " + j + ", icon: " + textureatlassprite1.getName());
                    } else {
    ...
    private static void addDefaultLocation(List list, String locBase, String pathSuffix) {
        ...
        Identifier identifier = new Identifier(locBase);
        PackResources packresources = Config.getDefiningResourcePack(identifier);
