...
public class ModelAdapterCopperGolem extends ModelAdapterLiving {
    public ModelAdapterCopperGolem() {
        super(EntityType.COPPER_GOLEM, "copper_golem", ModelLayers.COPPER_GOLEM);
    }

    @Override
    protected Model makeModel(ModelPart root) {
        return new CopperGolemModel(root);
    }
    ...
    protected LivingEntityRenderer makeLivingRenderer(EntityRendererProvider.Context context) {
        return new CopperGolemRenderer(context);
    }
}
