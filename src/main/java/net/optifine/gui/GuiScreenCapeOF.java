...
public class GuiScreenCapeOF extends GuiScreenOF {
        ...
        if (guiElement instanceof GuiButtonOF guibuttonof) {
            if (guibuttonof.active) {
                ...
                if (guibuttonof.id == 210) {
                    try {
                        String s = this.minecraft.getGameProfile().name();
                        String s1 = this.minecraft.getGameProfile().id().toString().replace("-", "");
                        ...
                        this.minecraft.services().sessionService().joinServer(this.minecraft.getGameProfile().id(), s2, s3);
    ...
    public void render(GuiGraphics graphicsIn, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(graphicsIn, this.fontRenderer, this.title, this.width / 2, 20, -1);
        if (this.message != null) {
            drawCenteredString(graphicsIn, this.fontRenderer, this.message, this.width / 2, this.height / 6 + 60, -1);
