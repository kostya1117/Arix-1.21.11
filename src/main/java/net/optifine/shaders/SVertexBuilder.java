...
public class SVertexBuilder {
    ...
    public static void pushEntity(BlockState blockState, VertexConsumer ivb) {
        if (ivb instanceof BufferBuilder bufferbuilder) {
            ...
            int i1 = j & 65535;
            bufferbuilder.sVertexBuilder.pushEntity(((long)i1 << 32) + l);
        }
    }
    ...
    public static void endAddVertex(BufferBuilder wrr) {
        if (!Config.isMinecraftThread() || !ItemRenderer.isRenderItemGui() && !GuiRenderer.isRenderGui()) {
            SVertexBuilder svertexbuilder = wrr.sVertexBuilder;
    ...
    public void calcNormal(BufferBuilder wrr, int baseIndex) {
        ...
        float f34 = f33 != 0.0 ? (float)(1.0 / Math.sqrt(f33)) : 1.0F;
        f30 *= f34;
        f31 *= f34;
        f32 *= f34;
        f20 = f5 - f;
        ...
        f34 = f33 != 0.0 ? (float)(1.0 / Math.sqrt(f33)) : 1.0F;
        f37 *= f34;
        f38 *= f34;
        f39 *= f34;
