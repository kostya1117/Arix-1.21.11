...
public class GuiShaderOptions extends GuiScreenOF {
    ...
    public void init() {
        ...
        if (ashaderoption != null) {
            int l1 = Mth.ceil(ashaderoption.length / 9.0);
            if (k1 < l1) {
                k1 = l1;
            }
            ...
            for (int i2 = 0; i2 < ashaderoption.length; i2++) {
                ...
                if (shaderoption != null && shaderoption.isVisible()) {
                    ...
                    if (Shaders.isShaderPackOptionSlider(shaderoption.getName())) {
                        guibuttonshaderoption = new GuiSliderShaderOption(i + i2, i3, j3, k3, l3, shaderoption, s);
                    } else {
                        guibuttonshaderoption = new GuiButtonShaderOption(i + i2, i3, j3, k3, l3, shaderoption, s);
                    }
    ...
    private void updateAllButtons() {
        ...
        for (AbstractWidget abstractWidget : this.getButtonList()) {
            Button btn = (Button) abstractWidget;
    ...
    public void render(GuiGraphics graphicsIn, int x, int y, float partialTicks) {
        ...
        if (this.screenText != null) {
            drawCenteredString(graphicsIn, this.fontRenderer, this.screenText, this.width / 2, 15, -1);
        } else {
