...
public class ShadersFramebuffer {
    ...
    public void setup() {
        ...
        RenderSystem.getGlDevice().debugLabels().applyLabelFramebuffer(this.glFramebuffer, this.name + "");
        ...
        for (int k = 0; k < this.usedDepthBuffers; k++) {
            ...
            RenderSystem.getGlDevice().debugLabels().applyLabelTexture(this.depthTextures.get(k), "FBS " + this.name + " depth #" + k);
        }
        ...
        for (int l = 0; l < this.usedColorBuffers; l++) {
            ...
            RenderSystem.getGlDevice().debugLabels().applyLabelTexture(this.colorTexturesFlip.getA(l), "FBS " + this.name + " colorA #" + l);
        }
        ...
        for (int i1 = 0; i1 < this.usedColorBuffers; i1++) {
            ...
            RenderSystem.getGlDevice().debugLabels().applyLabelTexture(this.colorTexturesFlip.getB(i1), "FBS " + this.name + " colorB #" + i1);
        }
