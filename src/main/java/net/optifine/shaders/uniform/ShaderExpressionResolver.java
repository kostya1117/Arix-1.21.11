...
public class ShaderExpressionResolver implements IExpressionResolver {
    ...
    private void registerExpressions() {
        ...
        for (Identifier identifier : BiomeUtils.getLocations()) {
            String s = identifier.getPath().trim();
            s = "BIOME_" + s.toUpperCase().replace(' ', '_');
            int j = BiomeUtils.getId(identifier);
        ...
        for (int l = 0; l < abiomecategory.length; l++) {
            ...
            int j1 = l;
            IExpression iexpression1 = new ConstantFloat(j1);
        ...
        for (int i1 = 0; i1 < abiome$precipitation.length; i1++) {
            ...
            int k1 = i1;
            IExpression iexpression2 = new ConstantFloat(k1);
