            ...
            if (this.indexNames2 == null || index2 >= 0 && index2 <= this.indexNames2.length) {
                switch (this) {
                    ...
                    case BIOME_PRECIPITATION:
                        ...
                        return holder2 != null ? BiomeUtils.getPrecipitation(holder2.value()).ordinal() : 0.0F;
                    case TEMPERATURE:
