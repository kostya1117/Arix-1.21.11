...
public class VersionCheckThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            URL url = new URL("http://optifine.net/version/1.21.11/HD_U.txt");
            httpurlconnection = (HttpURLConnection)url.openConnection();
            boolean flag = true;
            if (flag) {
                httpurlconnection.setRequestProperty("OF-MC-Version", "1.21.11");
                ...
                httpurlconnection.setRequestProperty("OF-Release", "J9");
            ...
            try {
                ...
                if (Config.compareRelease(s1, "J9") > 0) {
