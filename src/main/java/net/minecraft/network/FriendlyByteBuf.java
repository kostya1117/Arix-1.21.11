...
public class FriendlyByteBuf extends ByteBuf {
    ...
    public <T> void writeNullable( T p_329857_, StreamEncoder<? super FriendlyByteBuf, T> p_330309_) {
        writeNullable(this, p_329857_, p_330309_);
    }

    public static <T, B extends ByteBuf> void writeNullable(B p_334011_,  T p_236822_, StreamEncoder<? super B, T> p_335434_) {
        if (p_236822_ != null) {
    ...
    public FriendlyByteBuf writeNbt( Tag p_300580_) {
        writeNbt(this, p_300580_);
        return this;
    }

    public static void writeNbt(ByteBuf p_335073_,  Tag p_330157_) {
        if (p_330157_ == null) {
