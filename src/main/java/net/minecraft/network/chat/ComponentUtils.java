...
public class ComponentUtils {
    ...
    public static Component mergeStyles(Component p_453732_, Style p_456730_) {
        if (p_456730_.isEmpty()) {
            ...
            if (style.isEmpty()) {
                ...
                return style.equals(p_456730_) ? p_453732_ : p_453732_.copy().setStyle(style.applyTo(p_456730_));
            }
        }
    }

    public static Optional<MutableComponent> updateForEntity(
         CommandSourceStack p_178425_, Optional<Component> p_178426_,  Entity p_178427_, int p_178428_
    ) throws CommandSyntaxException {
        return p_178426_.isPresent() ? Optional.of(updateForEntity(p_178425_, p_178426_.get(), p_178427_, p_178428_)) : Optional.empty();
    }

    public static MutableComponent updateForEntity( CommandSourceStack p_130732_, Component p_130733_,  Entity p_130734_, int p_130735_) throws CommandSyntaxException {
        if (p_130735_ > 100) {
    ...
    private static Style resolveStyle( CommandSourceStack p_130737_, Style p_130738_,  Entity p_130739_, int p_130740_) throws CommandSyntaxException {
        if (p_130738_.getHoverEvent() instanceof HoverEvent.ShowText(Component component)) {
            HoverEvent hoverevent = new HoverEvent.ShowText(updateForEntity(p_130737_, component, p_130739_, p_130740_ + 1));
    ...
    public static Component fromMessage(Message p_130730_) {
        return p_130730_ instanceof Component component ? component : Component.literal(p_130730_.getString());
    }
