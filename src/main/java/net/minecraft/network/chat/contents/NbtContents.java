...
public class NbtContents implements ComponentContents {
    ...
    private NbtContents(String p_237389_, NbtPathArgument. NbtPath p_237390_, boolean p_237391_, Optional<Component> p_237392_, DataSource p_423664_) {
    ...
    @Override
    public MutableComponent resolve( CommandSourceStack p_237401_,  Entity p_237402_, int p_237403_) throws CommandSyntaxException {
