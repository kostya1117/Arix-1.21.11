...
public class ClientboundCommandsPacket implements Packet<ClientGamePacketListener> {
    ...
    record ArgumentNodeStub(String id, ArgumentTypeInfo.Template<?> argumentType,  Identifier suggestionId)
    ...
    public interface NodeBuilder<S> {
        ...
        ArgumentBuilder<S, ?> createArgument(String p_405834_, ArgumentType<?> p_408931_,  Identifier p_452401_);
    ...
    public interface NodeInspector<S> {
         Identifier suggestionId(ArgumentCommandNode<S, ?> p_408083_);
