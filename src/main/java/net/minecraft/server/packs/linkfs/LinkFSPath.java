...
class LinkFSPath implements Path {
    ...
    public LinkFSPath(LinkFileSystem p_251111_, String p_250681_,  LinkFSPath p_251363_, PathContents p_251268_) {
    ...
    private LinkFSPath createRelativePath( LinkFSPath p_249276_, String p_249966_) {
    ...
    public boolean startsWith(Path p_248923_) {
        ...
        if (p_248923_ instanceof LinkFSPath linkfspath) {
    ...
    public boolean endsWith(Path p_250070_) {
        ...
        if (p_250070_ instanceof LinkFSPath linkfspath) {
            if (linkfspath.fileSystem != this.fileSystem) {
                return false;
            }
    ...
    public boolean equals(Object p_248707_) {
        ...
        if (p_248707_ instanceof LinkFSPath linkfspath) {
    ...
    private LinkFSPath toLinkPath( Path p_250907_) {
        if (p_250907_ == null) {
