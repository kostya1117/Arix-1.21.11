...
public class VanillaPackResources implements PackResources {
    ...
    public void listRawPaths(PackType p_252103_, Identifier p_456273_, Consumer<Path> p_251968_) {
        FileUtil.decomposePath(p_456273_.getPath()).ifSuccess(partsIn -> {
        ...
        }).ifError(errorIn -> LOGGER.error("Invalid path {}: {}", p_456273_, errorIn.message()));
    }
    ...
    @Override
    public  IoSupplier<InputStream> getResource(PackType p_250512_, Identifier p_452512_) {
        IoSupplier<InputStream> iosupplier = this.getResourcesImpl(p_250512_, p_452512_);
        return iosupplier != null ? iosupplier : this.getResourceOF(p_250512_, p_452512_);
    }

    public  IoSupplier<InputStream> getResourcesImpl(PackType type, Identifier namespaceIn) {
    ...
    public IoSupplier<InputStream> getResourceOF(PackType type, Identifier locationIn) {
