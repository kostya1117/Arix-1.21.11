...
public class ServerPacksSource extends BuiltInPackSource {
    ...
    public static VanillaPackResources createVanillaPackSource() {
        return new VanillaPackResourcesBuilder().setMetadata(BUILT_IN_METADATA).exposeNamespace("minecraft","entityculling","viafabricplus","arix","voicechat").applyDevelopmentConfig().pushJarResources().build(VANILLA_PACK_INFO);
    }
