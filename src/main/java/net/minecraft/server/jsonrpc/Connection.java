...
public class Connection extends SimpleChannelInboundHandler<JsonElement> {
    ...
    private <Params, Result>  CompletableFuture<Result> sendRequest(
        Holder.Reference<? extends OutgoingRpcMethod<Params, ? extends Result>> p_424976_,  Params p_431689_, boolean p_428466_
    ) {
    ...
    @VisibleForTesting
     JsonObject handleJsonObject(JsonObject p_428341_) {
        try {
            ...
            if (s == null && jsonelement1 != null && jsonobject == null && jsonelement != null) {
    ...
    private  JsonObject handleIncomingRequest( JsonElement p_423022_, String p_425180_,  JsonElement p_423468_) {
    ...
    public  JsonElement dispatchIncomingRequest(String p_426702_,  JsonElement p_429101_) {
    ...
    private  JsonObject handleError( JsonElement p_428115_, JsonObject p_424320_) {
