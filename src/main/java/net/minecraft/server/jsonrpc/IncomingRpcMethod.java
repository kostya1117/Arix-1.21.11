...
public interface IncomingRpcMethod<Params, Result> {
    ...
    JsonElement apply(MinecraftApi p_425181_,  JsonElement p_424519_, ClientInfo p_431211_);
    ...
    record Method<Params, Result>(
        ...
        @Override
        public JsonElement apply(MinecraftApi p_429665_,  JsonElement p_424548_, ClientInfo p_427391_) {
    ...
    record ParameterlessMethod<Params, Result>(
        ...
        @Override
        public JsonElement apply(MinecraftApi p_430683_,  JsonElement p_427524_, ClientInfo p_423407_) {
