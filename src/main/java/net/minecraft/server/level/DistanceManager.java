        ...
        if (!this.chunksToUpdateFutures.isEmpty()) {
            ...
            if (!this.ticketsToRelease.isEmpty()) {
                ...
                while (longiterator.hasNext()) {
                    ...
                    if (this.ticketStorage.getTickets(j).stream().anyMatch(ticketIn -> ticketIn.getType() == TicketType.PLAYER_LOADING)) {
                        ...
                        completablefuture.thenAccept(voidIn -> this.mainThreadExecutor.execute(() -> this.ticketDispatcher.release(j, () -> {}, false)));
                    }
                }
