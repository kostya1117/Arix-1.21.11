...
public interface ServerEntityGetter extends EntityGetter {
    ...
    default <T extends LivingEntity>  T getNearestEntity(
        List<? extends T> p_363565_, TargetingConditions p_366923_,  LivingEntity p_362427_, double p_366460_, double p_364508_, double p_364611_
    ) {
        double d0 = -1.0;
        T t = null;
