...
public final class Identifier implements Comparable<Identifier> {
    ...
    public Identifier(String p_453419_, String p_457561_) {
        this.namespace = p_453419_;
        this.path = p_457561_;
        this.defaultNamespace = "minecraft".equals(p_453419_);
    }
    ...
    public static  Identifier tryBuild(String p_458111_, String p_455894_) {
    ...
    public static  Identifier tryBySeparator(String p_458139_, char p_459073_) {
    ...
    public Identifier removePrefix(String prefix) {
        ...
        return new Identifier(this.namespace, s);
    }

    public Identifier removeSuffix(String suffix) {
        String s = StrUtils.removeSuffix(this.path, suffix);
        return new Identifier(this.namespace, s);
    }

    public Identifier removePrefixSuffix(String prefix, String suffix) {
