                    ...
                    p_449299_ = p_449299_.updateTyped(opticfinder1, type3, p_184936_ -> {
                        ...
                        List<Dynamic<?>> list = dynamic3.asStream().map(p_184927_ -> {
                            ...
                            if (i1 >= 0 && i1 < dynamic1.length) {
                                dynamic6 = dynamic6.set("biomes", dynamic1[i1]);
                            }
    ...
    private static Dynamic<?>[] getBiomeContainers(Dynamic<?> p_184907_, boolean p_184908_, int p_184909_, MutableBoolean p_184910_) {
        ...
        if (aint != null && aint.length == 1536) {
            ...
            for (int i = 0; i < 16; i++) {
                int j = i - p_184909_;
                int k = i;
                dynamic[j] = makeBiomeContainer(p_184907_, p_184954_ -> getOldBiome(aint, k * 64 + p_184954_));
            }
        ...
        if (optional.isPresent()) {
            ...
            if (!"empty".equals(s)) {
                p_184912_ = p_184912_.set(
                    "blending_data", p_184912_.createMap(ImmutableMap.of(p_184912_.createString("old_noise"), p_184912_.createBoolean(STATUS_IS_OR_AFTER_NOISE.contains(s))))
                );
