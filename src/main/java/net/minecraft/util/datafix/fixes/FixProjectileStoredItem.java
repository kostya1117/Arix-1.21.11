...
public class FixProjectileStoredItem extends DataFix {
    ...
    private static <T> Function<Typed<?>, Typed<?>> fixChoiceCap(
        ...
        FixProjectileStoredItem.SubFixer<T> subfixer = (FixProjectileStoredItem.SubFixer<T>)p_310164_;
        return p_313205_ -> p_313205_.updateTyped(opticfinder, p_312528_, p_312567_ -> subfixer.fix(p_312567_, p_312528_));
    }
