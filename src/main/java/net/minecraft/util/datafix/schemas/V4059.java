...
public class V4059 extends NamespacedSchema {
    ...
    public static SequencedMap<String, Supplier<TypeTemplate>> components(Schema p_363212_) {
        ...
        sequencedmap.put("minecraft:use_remainder", (Supplier<TypeTemplate>)() -> References.ITEM_STACK.in(p_363212_));
        sequencedmap.put(
            "minecraft:equippable",
            (Supplier<TypeTemplate>)() -> DSL.optionalFields(
                "allowed_entities", DSL.or(References.ENTITY_NAME.in(p_363212_), DSL.list(References.ENTITY_NAME.in(p_363212_)))
            )
        );
        return sequencedmap;
    }
