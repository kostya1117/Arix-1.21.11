...
public class V4307 extends NamespacedSchema {
    ...
    public static SequencedMap<String, Supplier<TypeTemplate>> components(Schema p_392155_) {
        ...
        sequencedmap.put("minecraft:can_place_on", (Supplier<TypeTemplate>)() -> adventureModePredicate(p_392155_));
        sequencedmap.put("minecraft:can_break", (Supplier<TypeTemplate>)() -> adventureModePredicate(p_392155_));
        return sequencedmap;
    }
