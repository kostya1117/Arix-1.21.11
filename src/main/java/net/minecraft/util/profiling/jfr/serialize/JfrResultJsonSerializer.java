...
public class JfrResultJsonSerializer {
    ...
    private JsonElement structureGen(List<StructureGenStat> p_375433_) {
        ...
        p_375433_.stream().collect(Collectors.groupingBy(StructureGenStat::structureName)).forEach((p_449369_, p_449370_) -> {
    ...
    private JsonElement chunkGen(List<Pair<ChunkStatus, TimedStatSummary<ChunkGenStat>>> p_185573_) {
        ...
        for (Pair<ChunkStatus, TimedStatSummary<ChunkGenStat>> pair : p_185573_) {
            ...
            jsonobject1.add("secondSlowest", timedstatsummary.secondSlowest() != null ? function.apply(timedstatsummary.secondSlowest()) : JsonNull.INSTANCE);
        }
