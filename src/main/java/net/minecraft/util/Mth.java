...
public class Mth {
    ...
    private static final int SIN_COUNT_FAST_D4 = 1024;
    ...
    public static IntStream outFromOrigin(int p_216251_, int p_216252_, int p_216253_, int p_216254_) {
        ...
        return IntStream.iterate(i, p_216278_3_ -> {
            int j = Math.abs(i - p_216278_3_);
            return i - j >= p_216252_ || i + j <= p_216253_;
        }, p_216255_4_ -> {
            boolean flag = p_216255_4_ <= i;
            int j = Math.abs(i - p_216255_4_);
