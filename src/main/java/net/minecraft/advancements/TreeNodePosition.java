...
public class TreeNodePosition {
    ...
    public TreeNodePosition(AdvancementNode p_297517_,  TreeNodePosition p_16568_,  TreeNodePosition p_16569_, int p_16570_, int p_16571_) {
    ...
    private  TreeNodePosition addChild(AdvancementNode p_298340_,  TreeNodePosition p_16591_) {
