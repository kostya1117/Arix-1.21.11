...
public class BlockModelGenerators {
                                ...
                                p_447868_ -> {
                                    ...
                                    return plainVariant(
                                        int2objectmap.computeIfAbsent(
                                            i,
                                            p_447927_ -> this.createSuffixedVariant(p_378549_, "_stage" + p_447927_, ModelTemplates.CROP, TextureMapping::crop)
                                        )
                                    );
                                }
                            )
    ...
    private static Condition shelfCondition(Direction p_426934_,  Boolean p_428550_,  SideChainPart p_426790_) {
    ...
    private void createShulkerBox(Block p_376780_,  DyeColor p_378224_) {
    ...
    enum PlantType {
        ...
        PlantType(final ModelTemplate p_376693_, final ModelTemplate p_377578_, final boolean p_378590_) {
