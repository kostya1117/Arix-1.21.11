...
public class DynamicUniforms implements AutoCloseable {
    ...
    public record ChunkSectionInfo(
        Matrix4fc modelView, int x, int y, int z, float visibility, int textureAtlasWidth, int textureAtlasHeight, double px, double py, double pz
        ...
        public ChunkSectionInfo(Matrix4fc modelView, int x, int y, int z, float visibility, int textureAtlasWidth, int textureAtlasHeight) {
            this(modelView, x, y, z, visibility, textureAtlasWidth, textureAtlasHeight, 0.0, 0.0, 0.0);
        }
