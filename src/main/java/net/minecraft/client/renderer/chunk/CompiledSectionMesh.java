...
public class CompiledSectionMesh implements SectionMesh {
    ...
    private BitSet[] animatedSprites = new BitSet[ChunkSectionLayer.VALUES.length];
    private final Set<ChunkSectionLayer> layersUsed = this.buffers.keySet();
    ...
    public void uploadMeshLayer(ChunkSectionLayer p_406382_, MeshData p_410167_, long p_406090_) {
        ...
        if (sectionbuffers != null) {
            ...
            if (this.vboRegions != null) {
                sectionbuffers1.setVboRegion(this.vboRegions[p_406382_.ordinal()]);
            }

            this.buffers.put(p_406382_, sectionbuffers1);
            sectionbuffers = sectionbuffers1;
        }

        sectionbuffers.upload(p_410167_);
    }
    ...
    public void uploadLayerIndexBuffer(ChunkSectionLayer p_406407_, ByteBufferBuilder.Result p_409808_, long p_408270_) {
        ...
        if (sectionbuffers != null) {
            ...
            sectionbuffers.updateMultiTextureData();
        }
    }
    ...
    @Override
    public BitSet getAnimatedSprites(ChunkSectionLayer layerIn) {
        return this.animatedSprites[layerIn.ordinal()];
    }
    ...
    @Override
    public boolean isLayerUsed(ChunkSectionLayer layerIn) {
        return this.layersUsed.contains(layerIn);
    }
    ...
    public boolean isEmpty() {
        return this.layersUsed.isEmpty();
    }

    @Override
    public Set<ChunkSectionLayer> getLayersUsed() {
        return this.layersUsed;
    }
}
