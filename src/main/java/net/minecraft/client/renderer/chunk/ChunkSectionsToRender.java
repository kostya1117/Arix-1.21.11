...
public record ChunkSectionsToRender(
    ...
    public void renderGroup(ChunkSectionLayerGroup p_406533_, GpuSampler p_455406_) {
        ...
        try (RenderPass renderpass = RenderSystem.getDevice()
                ...
                .createRenderPass(
                    () -> "BL: " + p_406533_.label(), rendertarget.getColorTextureView(), OptionalInt.empty(), rendertarget.getDepthTextureView(), OptionalDouble.empty()
                )) {
            ...
            for (ChunkSectionLayer chunksectionlayer : achunksectionlayer) {
                ...
                if (!list.isEmpty()) {
                    if (flag1) {
                        ShadersRender.preRenderChunkLayer(chunksectionlayer);
                    }
                    ...
                    if (flag1) {
                        ShadersRender.postRenderChunkLayer(chunksectionlayer);
                    }
                }
            }
        }
