...
public class RenderPipelines {
    ...
    public static final RenderPipeline CUTOUT_BLOCK = register(
        RenderPipeline.builder(BLOCK_SNIPPET).withLocation("pipeline/cutout_block").withShaderDefine("ALPHA_CUTOUT", 0.1F).build()
    );
    public static final RenderPipeline CUTOUT_TERRAIN = register(
        RenderPipeline.builder(TERRAIN_SNIPPET).withLocation("pipeline/cutout_terrain").withShaderDefine("ALPHA_CUTOUT", 0.1F).build()
    );
    ...
    public static final RenderPipeline POSITION = register(
        RenderPipeline.builder(MATRICES_PROJECTION_SNIPPET)
            .withLocation("pipeline/position")
            .withVertexShader("core/position")
            .withFragmentShader("core/position")
            .withDepthWrite(false)
            .withVertexFormat(DefaultVertexFormat.POSITION, VertexFormat.Mode.QUADS)
