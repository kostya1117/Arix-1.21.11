...
public interface SpecialModelRenderer<T> {
    ...
    interface BakingContext {
        ...
        record Simple(EntityModelSet entityModelSet, MaterialSet materials, PlayerSkinRenderCache playerSkinRenderCache) implements SpecialModelRenderer.BakingContext {
            @Override
