...
public class SubmitNodeStorage implements SubmitNodeCollector {
    ...
    public SubmitNodeCollection order(int p_430976_) {
        return this.submitsPerOrder.computeIfAbsent(p_430976_, order2In -> new SubmitNodeCollection(this));
    }
    ...
    public <S> void submitModel(
        ...
        int p_425107_,
        int p_423377_,
         TextureAtlasSprite p_426883_,
        int p_426628_,
        ModelFeatureRenderer. CrumblingOverlay p_431344_
    ) {
    ...
    public void endFrame() {
        this.submitsPerOrder.values().removeIf(coll2In -> !coll2In.wasUsed());
    ...
    public record CustomGeometrySubmit(PoseStack.Pose pose, SubmitNodeCollector.CustomGeometryRenderer customGeometryRenderer, Object renderState) {
        public CustomGeometrySubmit(PoseStack.Pose pose, SubmitNodeCollector.CustomGeometryRenderer customGeometryRenderer) {
            this(pose, customGeometryRenderer, RenderState.getRenderState());
        }
    }
    ...
    public record ModelSubmit<S>(
        ...
        public ModelSubmit(
            ...
            this(pose, model, state, lightCoords, overlayCoords, tintedColor, sprite, outlineColor, crumblingOverlay, RenderState.getRenderState());
        }
    }
