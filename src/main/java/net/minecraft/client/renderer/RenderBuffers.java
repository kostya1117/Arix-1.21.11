...
public class RenderBuffers {
    ...
    public RenderBuffers(int p_312933_) {
        ...
        SequencedMap<RenderType, ByteBufferBuilder> sequencedmap = Util.make(
            new Object2ObjectLinkedOpenHashMap<RenderType, ByteBufferBuilder>(), p_357875_ -> {
        ...
        SequencedMap<RenderType, ByteBufferBuilder> sequencedmap1 = Util.make(
            ...
            p_357874_ -> ModelBakery.DESTROY_TYPES.forEach(p_448189_ -> put(p_357874_, p_448189_))
        );
