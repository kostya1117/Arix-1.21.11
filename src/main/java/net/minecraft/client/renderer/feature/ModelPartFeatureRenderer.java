...
public class ModelPartFeatureRenderer {
    ...
    public static class Storage {
        ...
        public void add(RenderType p_453839_, SubmitNodeStorage.ModelPartSubmit p_428026_) {
            this.modelPartSubmits.computeIfAbsent(p_453839_, type2In -> new ArrayList<>()).add(p_428026_);
        }
        ...
        public void endFrame() {
            this.modelPartSubmits.keySet().removeIf(type2In -> !this.modelPartSubmitsUsage.contains(type2In));
        ...
        public int getCount() {
            ...
            for (List list : this.modelPartSubmits.values()) {
                i += list.size();
            }
