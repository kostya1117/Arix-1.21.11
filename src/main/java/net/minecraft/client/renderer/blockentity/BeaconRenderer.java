...
public class BeaconRenderer<T extends BlockEntity & BeaconBeamOwner> implements BlockEntityRenderer<T, BeaconRenderState> {
    ...
    public void extractRenderState(T p_431678_, BeaconRenderState p_429388_, float p_429147_, Vec3 p_430767_, ModelFeatureRenderer. CrumblingOverlay p_425159_) {
    ...
    public static void submitBeaconBeam(
        ...
        float f11 = 1.0F;
        float f12 = -1.0F + f1;
        float f13 = p_426161_ * p_430510_ * (0.5F / p_428444_) + f12;
        float finalF = f3;
        float finalF1 = f4;
        float finalF2 = f6;
        float finalF3 = f9;
        ...
        p_423842_.submitCustomGeometry(
            ...
            (p_425436_, p_430525_) -> renderPart(p_425436_, p_430525_, p_427198_, p_427512_, i, 0.0F, finalF, finalF1, 0.0F, finalF2, 0.0F, 0.0F, finalF3, 0.0F, 1.0F, finalF4, finalF5)
        );
        p_430215_.popPose();
        f2 = -p_424527_;
        f3 = -p_424527_;
        ...
        p_423842_.submitCustomGeometry(
            ...
            (p_427615_, p_428983_) -> renderPart(
                p_427615_, p_428983_, ARGB.color(32, p_427198_), p_427512_, i, finalF6, finalF7, finalF8, finalF9, finalF10, finalF11, finalF12, finalF13, 0.0F, 1.0F, finalF14, finalF15
            )
        );
        p_430215_.popPose();
    }
