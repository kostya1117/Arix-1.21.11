...
public class CompassAngleState extends NeedleDirectionHelper {
    ...
    private static boolean isValidCompassTargetPos(ItemOwner p_423243_,  GlobalPos p_376149_) {
    ...
    public enum CompassTarget implements StringRepresentable {
        NONE("none") {
            @Override
            public  GlobalPos get(ClientLevel p_375914_, ItemStack p_376028_,  ItemOwner p_423750_) {
                return null;
            }
        },
        LODESTONE("lodestone") {
            @Override
            public  GlobalPos get(ClientLevel p_376563_, ItemStack p_377548_,  ItemOwner p_423946_) {
        ...
        SPAWN("spawn") {
            @Override
            public GlobalPos get(ClientLevel p_378146_, ItemStack p_377238_,  ItemOwner p_425022_) {
                return p_378146_.getRespawnData().globalPos();
            }
        },
        RECOVERY("recovery") {
            @Override
            public  GlobalPos get(ClientLevel p_375618_, ItemStack p_378046_,  ItemOwner p_425437_) {
        ...
        abstract  GlobalPos get(ClientLevel p_375459_, ItemStack p_375402_,  ItemOwner p_428349_);
    }
}
