...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon, EnderDragonRenderState> {
    ...
    public void submit(EnderDragonRenderState p_430659_, PoseStack p_425524_, SubmitNodeCollector p_423449_, CameraRenderState p_424851_) {
        ...
        if (p_430659_.deathTime > 0.0F) {
            ...
            RenderType rendertype = RenderTypes.entityDecal(DRAGON_LOCATION);
            p_423449_.order(1).submitModel(this.model, p_430659_, p_425524_, rendertype, p_430659_.lightCoords, i, -1, null, p_430659_.outlineColor, null);
        } else {
            RenderType rendertype1 = RenderTypes.entityCutoutNoCull(DRAGON_LOCATION);
            p_423449_.order(0).submitModel(this.model, p_430659_, p_425524_, rendertype1, p_430659_.lightCoords, i, -1, null, p_430659_.outlineColor, null);
        }

        RenderType rendertype2 = RenderTypes.eyes(DRAGON_EYES_LOCATION);
        p_423449_.submitModel(this.model, p_430659_, p_425524_, rendertype2, p_430659_.lightCoords, OverlayTexture.NO_OVERLAY, p_430659_.outlineColor, null);
        if (p_430659_.deathTime > 0.0F) {
        ...
        p_425353_.submitCustomGeometry(
            ...
            (matrix2In, buffer2In) -> {
                ...
                for (int l = 0; l < k; l++) {
                    ...
                    buffer2In.addVertex(matrix2In, vector3f).setColor(i);
                    buffer2In.addVertex(matrix2In, vector3f1).setColor(16711935);
                    buffer2In.addVertex(matrix2In, vector3f2).setColor(16711935);
                    buffer2In.addVertex(matrix2In, vector3f).setColor(i);
                    buffer2In.addVertex(matrix2In, vector3f2).setColor(16711935);
                    buffer2In.addVertex(matrix2In, vector3f3).setColor(16711935);
                    buffer2In.addVertex(matrix2In, vector3f).setColor(i);
                    buffer2In.addVertex(matrix2In, vector3f3).setColor(16711935);
                    buffer2In.addVertex(matrix2In, vector3f1).setColor(16711935);
                }
    ...
    public static void submitCrystalBeams(
        ...
        RenderType rendertype = RenderTypes.entitySmoothCutout(CRYSTAL_BEAM_LOCATION);
        p_429648_.submitCustomGeometry(
            ...
            (matrix2In, buffer2In) -> {
                ...
                for (int j = 1; j <= 8; j++) {
                    ...
                    float f9 = j / 8.0F;
                    buffer2In.addVertex(matrix2In, f4 * 0.2F, f5 * 0.2F, 0.0F)
                        .setColor(-16777216)
                        .setUv(f6, f2)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(p_425816_)
                        .setNormal(matrix2In, 0.0F, -1.0F, 0.0F);
                    buffer2In.addVertex(matrix2In, f4, f5, f1)
                        .setColor(-1)
                        .setUv(f6, f3)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(p_425816_)
                        .setNormal(matrix2In, 0.0F, -1.0F, 0.0F);
                    buffer2In.addVertex(matrix2In, f7, f8, f1)
                        .setColor(-1)
                        .setUv(f9, f3)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(p_425816_)
                        .setNormal(matrix2In, 0.0F, -1.0F, 0.0F);
                    buffer2In.addVertex(matrix2In, f7 * 0.2F, f8 * 0.2F, 0.0F)
                        .setColor(-16777216)
                        .setUv(f9, f2)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(p_425816_)
