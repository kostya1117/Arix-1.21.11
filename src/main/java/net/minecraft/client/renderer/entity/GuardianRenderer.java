...
public class GuardianRenderer extends MobRenderer<Guardian, GuardianRenderState, GuardianModel> {
    ...
    private static void renderBeam(PoseStack p_362984_, SubmitNodeCollector p_426389_, Vec3 p_364612_, float p_368702_, float p_364900_, float p_363883_) {
        ...
        float f24 = 0.0F;
        float f25 = 0.4999F;
        float f26 = -1.0F + p_363883_;
        float f27 = f26 + f * 2.5F;
        p_426389_.submitCustomGeometry(p_362984_, BEAM_RENDER_TYPE, (p_430440_, p_424942_) -> {
            vertex(p_424942_, p_430440_, f15, f23, f16, i, j, k, 0.4999F, f27);
            vertex(p_424942_, p_430440_, f15, 0.0F, f16, i, j, k, 0.4999F, f26);
            vertex(p_424942_, p_430440_, f17, 0.0F, f18, i, j, k, 0.0F, f26);
            vertex(p_424942_, p_430440_, f17, f23, f18, i, j, k, 0.0F, f27);
            vertex(p_424942_, p_430440_, f19, f23, f20, i, j, k, 0.4999F, f27);
            vertex(p_424942_, p_430440_, f19, 0.0F, f20, i, j, k, 0.4999F, f26);
            vertex(p_424942_, p_430440_, f21, 0.0F, f22, i, j, k, 0.0F, f26);
            vertex(p_424942_, p_430440_, f21, f23, f22, i, j, k, 0.0F, f27);
            float f28 = Mth.floor(p_368702_) % 2 == 0 ? 0.5F : 0.0F;
            vertex(p_424942_, p_430440_, f7, f23, f8, i, j, k, 0.5F, f28 + 0.5F);
            vertex(p_424942_, p_430440_, f9, f23, f10, i, j, k, 1.0F, f28 + 0.5F);
            vertex(p_424942_, p_430440_, f13, f23, f14, i, j, k, 1.0F, f28);
            vertex(p_424942_, p_430440_, f11, f23, f12, i, j, k, 0.5F, f28);
        });
    }
