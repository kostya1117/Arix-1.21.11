...
public class BreezeWindLayer extends RenderLayer<BreezeRenderState, BreezeModel> {
    private Identifier TEXTURE_LOCATION = Identifier.withDefaultNamespace("textures/entity/breeze/breeze_wind.png");
    ...
    public void submit(PoseStack p_423827_, SubmitNodeCollector p_423334_, int p_426201_, BreezeRenderState p_424120_, float p_428800_, float p_429670_) {
        RenderType rendertype = RenderTypes.breezeWind(this.TEXTURE_LOCATION, this.xOffset(p_424120_.ageInTicks) % 1.0F, 0.0F);
        p_423334_.order(1)
