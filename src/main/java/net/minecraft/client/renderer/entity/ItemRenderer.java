...
public class ItemRenderer {
    ...
    public static void renderItem(
        ...
        setRenderItemGui(p_362035_ == ItemDisplayContext.GUI);
        ...
        if (EmissiveTextures.isActive()) {
            if (EmissiveTextures.hasEmissive()) {
                ...
                VertexConsumer vertexconsumer1 = vertexconsumer instanceof VertexBuilderWrapper
                    ...
                    : vertexconsumer;
                renderQuadList(p_370127_, vertexconsumer1, p_395550_, p_378157_, LightTexture.MAX_BRIGHTNESS, p_367651_);
    ...
    private static void renderQuadList(PoseStack p_115163_, VertexConsumer p_115164_, List<BakedQuad> p_115165_, int[] p_375549_, int p_115167_, int p_115168_) {
        ...
        for (int j = 0; j < i; j++) {
            BakedQuad bakedquad = p_115165_.get(j);
            if (flag) {
            ...
            if (bakedquad.isTinted()) {
                int k = getLayerColorSafe(p_375549_, bakedquad.tintIndex());
                f = ARGB.alpha(k) / 255.0F;
                f1 = ARGB.red(k) / 255.0F;
                f2 = ARGB.green(k) / 255.0F;
                f3 = ARGB.blue(k) / 255.0F;
            } else {
                f = 1.0F;
                f1 = 1.0F;
                f2 = 1.0F;
