...
public class PaintingRenderer extends EntityRenderer<Painting, PaintingRenderState> {
    ...
    int[] maxBrightnessArray = new int[0];
        ...
        if (paintingvariant != null) {
            ...
            if (EmissiveTextures.hasEmissive()) {
                ...
                this.renderPainting(
                    p_431188_,
                    p_431178_,
                    RenderTypes.entityCutoutNoCullZOffset(textureatlassprite1.atlasLocation()),
                    this.getMaxBrightness(p_426919_.lightCoordsPerBlock),
                    paintingvariant.width(),
                    paintingvariant.height(),
                    textureatlassprite,
                    textureatlassprite1
    ...
    private void renderPainting(
        ...
        p_427389_.submitCustomGeometry(p_115559_, p_453537_, (matrixIn, bufferIn) -> {
            ...
            for (int i = 0; i < p_115562_; i++) {
                for (int j = 0; j < p_115563_; j++) {
                    ...
                    this.vertex(matrixIn, bufferIn, f15, f18, f20, f21, -0.03125F, 0, 0, -1, k);
                    this.vertex(matrixIn, bufferIn, f16, f18, f19, f21, -0.03125F, 0, 0, -1, k);
                    this.vertex(matrixIn, bufferIn, f16, f17, f19, f22, -0.03125F, 0, 0, -1, k);
                    this.vertex(matrixIn, bufferIn, f15, f17, f20, f22, -0.03125F, 0, 0, -1, k);
                    this.vertex(matrixIn, bufferIn, f15, f17, f4, f5, 0.03125F, 0, 0, 1, k);
                    this.vertex(matrixIn, bufferIn, f16, f17, f3, f5, 0.03125F, 0, 0, 1, k);
                    this.vertex(matrixIn, bufferIn, f16, f18, f3, f6, 0.03125F, 0, 0, 1, k);
                    this.vertex(matrixIn, bufferIn, f15, f18, f4, f6, 0.03125F, 0, 0, 1, k);
                    this.vertex(matrixIn, bufferIn, f15, f17, f7, f9, -0.03125F, 0, 1, 0, k);
                    this.vertex(matrixIn, bufferIn, f16, f17, f8, f9, -0.03125F, 0, 1, 0, k);
                    this.vertex(matrixIn, bufferIn, f16, f17, f8, f10, 0.03125F, 0, 1, 0, k);
                    this.vertex(matrixIn, bufferIn, f15, f17, f7, f10, 0.03125F, 0, 1, 0, k);
                    this.vertex(matrixIn, bufferIn, f15, f18, f7, f9, 0.03125F, 0, -1, 0, k);
                    this.vertex(matrixIn, bufferIn, f16, f18, f8, f9, 0.03125F, 0, -1, 0, k);
                    this.vertex(matrixIn, bufferIn, f16, f18, f8, f10, -0.03125F, 0, -1, 0, k);
                    this.vertex(matrixIn, bufferIn, f15, f18, f7, f10, -0.03125F, 0, -1, 0, k);
                    this.vertex(matrixIn, bufferIn, f15, f17, f12, f13, 0.03125F, -1, 0, 0, k);
                    this.vertex(matrixIn, bufferIn, f15, f18, f12, f14, 0.03125F, -1, 0, 0, k);
                    this.vertex(matrixIn, bufferIn, f15, f18, f11, f14, -0.03125F, -1, 0, 0, k);
                    this.vertex(matrixIn, bufferIn, f15, f17, f11, f13, -0.03125F, -1, 0, 0, k);
                    this.vertex(matrixIn, bufferIn, f16, f17, f12, f13, -0.03125F, 1, 0, 0, k);
                    this.vertex(matrixIn, bufferIn, f16, f18, f12, f14, -0.03125F, 1, 0, 0, k);
                    this.vertex(matrixIn, bufferIn, f16, f18, f11, f14, 0.03125F, 1, 0, 0, k);
                    this.vertex(matrixIn, bufferIn, f16, f17, f11, f13, 0.03125F, 1, 0, 0, k);
                }
            }
        });
    }
    ...
    private int[] getMaxBrightness(int[] arr) {
        if (this.maxBrightnessArray.length < arr.length) {
            this.maxBrightnessArray = new int[arr.length];
            Arrays.fill(this.maxBrightnessArray, LightTexture.MAX_BRIGHTNESS);
        }

        return this.maxBrightnessArray;
    }
}
