...
public class EquipmentLayerRenderer {
    ...
    public EquipmentLayerRenderer(EquipmentAssetManager p_375597_, TextureAtlas p_363154_) {
        ...
        this.trimSpriteLookup = Util.memoize(keyIn -> p_363154_.getSprite(keyIn.spriteId()));
    }
            ...
            for (EquipmentClientInfo.Layer equipmentclientinfo$layer : list) {
                ...
                if (k != 0) {
                    ...
                    if (Config.isCustomItems()) {
                        identifier = CustomItems.getCustomArmorTexture(p_368999_, p_376060_, equipmentclientinfo$layer, identifier);
                    }

                    if (p_366052_.locationTextureCustom != null) {
                        identifier = p_366052_.locationTextureCustom;
                    }
