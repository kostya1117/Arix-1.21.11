    ...
    private static NativeImage processLegacySkin(NativeImage p_378771_, String p_376069_) {
        ...
        if (j == 64 && (i == 32 || i == 64)) {
            ...
            if (flag) {
                ...
                p_378771_.fillRect(0, 32, 64, 32, 0);
                p_378771_.copyRect(4, 16, 16, 32, 4, 4, true, false);
                p_378771_.copyRect(8, 16, 16, 32, 4, 4, true, false);
                p_378771_.copyRect(0, 20, 24, 32, 4, 12, true, false);
                p_378771_.copyRect(4, 20, 16, 32, 4, 12, true, false);
                p_378771_.copyRect(8, 20, 8, 32, 4, 12, true, false);
                p_378771_.copyRect(12, 20, 16, 32, 4, 12, true, false);
                p_378771_.copyRect(44, 16, -8, 32, 4, 4, true, false);
                p_378771_.copyRect(48, 16, -8, 32, 4, 4, true, false);
                p_378771_.copyRect(40, 20, 0, 32, 4, 12, true, false);
                p_378771_.copyRect(44, 20, -8, 32, 4, 12, true, false);
                p_378771_.copyRect(48, 20, -16, 32, 4, 12, true, false);
                p_378771_.copyRect(52, 20, -8, 32, 4, 12, true, false);
            }
