...
public final class RenderSetup {
    ...
    RenderSetup(
        ...
        this(p_455545_, p_455652_, p_459117_, p_460590_, p_458911_, p_457054_, p_453948_, p_454071_, p_455910_, p_450946_, p_453755_, new HashMap<>());
    }

    RenderSetup(
        RenderPipeline pipelineIn,
        Map<String, RenderSetup.TextureBinding> texturesIn,
        boolean lightmapIn,
        boolean overlayIn,
        LayeringTransform layerTransformIn,
        OutputTarget targetIn,
        TextureTransform texTransformIn,
        RenderSetup.OutlineProperty outlineIn,
        boolean crumblingIn,
        boolean sortIn,
        int bufferSizeIn,
        ...
        this.useLightmap = lightmapIn;
        this.useOverlay = overlayIn;
        this.outlineProperty = outlineIn;
        this.layeringTransform = layerTransformIn;
        this.affectsCrumbling = crumblingIn;
        this.sortOnUpload = sortIn;
    ...
    public RenderSetup duplicate() {
        Map<String, RenderSetup.TextureBinding> map = new HashMap<>(this.textures);
    ...
    public Map<String, RenderSetup.TextureAndSampler> getTextures() {
        ...
        for (Entry<String, RenderSetup.TextureBinding> entry : this.textures.entrySet()) {
            ...
            map.put(
                entry.getKey(), new RenderSetup.TextureAndSampler(abstracttexture.getTextureView(), gpusampler != null ? gpusampler : abstracttexture.getSampler())
            );
        }
    ...
    public enum OutlineProperty {
        ...
        OutlineProperty(final String p_452545_) {
            this.name = p_452545_;
        }
