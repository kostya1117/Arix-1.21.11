...
public class RenderTypes {
    static final BiFunction<Identifier, Boolean, RenderType> OUTLINE = Util.memoize(
        (p_439897_0_, p_439897_1_) -> RenderType.create(
            "outline",
            RenderSetup.builder(p_439897_1_ ? RenderPipelines.OUTLINE_CULL : RenderPipelines.OUTLINE_NO_CULL)
                .withTexture("Sampler0", p_439897_0_)
    ...
    private static final Function<Identifier, RenderType> ARMOR_CUTOUT_NO_CULL = Util.memoize(
        p_443538_0_ -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ARMOR_CUTOUT_NO_CULL)
                .withTexture("Sampler0", p_443538_0_)
                .useLightmap()
                .useOverlay()
    ...
    private static final Function<Identifier, RenderType> ARMOR_TRANSLUCENT = Util.memoize(
        p_443772_0_ -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ARMOR_TRANSLUCENT)
                .withTexture("Sampler0", p_443772_0_)
                .useLightmap()
                .useOverlay()
                .setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING)
                .affectsCrumbling()
    ...
    private static final Function<Identifier, RenderType> ENTITY_SOLID = Util.memoize(
        p_445978_0_ -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ENTITY_SOLID)
                .withTexture("Sampler0", p_445978_0_)
                .useLightmap()
                .useOverlay()
                .affectsCrumbling()
                .setOutline(RenderSetup.OutlineProperty.AFFECTS_OUTLINE)
    ...
    private static final Function<Identifier, RenderType> ENTITY_SOLID_Z_OFFSET_FORWARD = Util.memoize(
        p_441665_0_ -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ENTITY_SOLID_Z_OFFSET_FORWARD)
                .withTexture("Sampler0", p_441665_0_)
                .useLightmap()
                .useOverlay()
    ...
    private static final Function<Identifier, RenderType> ENTITY_CUTOUT = Util.memoize(
        p_442947_0_ -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ENTITY_CUTOUT)
                .withTexture("Sampler0", p_442947_0_)
                .useLightmap()
                .useOverlay()
                .affectsCrumbling()
                .setOutline(RenderSetup.OutlineProperty.AFFECTS_OUTLINE)
    ...
    private static final BiFunction<Identifier, Boolean, RenderType> ENTITY_CUTOUT_NO_CULL = Util.memoize(
        (p_446174_0_, p_446174_1_) -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ENTITY_CUTOUT_NO_CULL)
                .withTexture("Sampler0", p_446174_0_)
                .useLightmap()
                .useOverlay()
                .affectsCrumbling()
                .setOutline(p_446174_1_ ? RenderSetup.OutlineProperty.AFFECTS_OUTLINE : RenderSetup.OutlineProperty.NONE)
                .createRenderSetup();
    ...
    private static final BiFunction<Identifier, Boolean, RenderType> ENTITY_CUTOUT_NO_CULL_Z_OFFSET = Util.memoize(
        (p_440312_0_, p_440312_1_) -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ENTITY_CUTOUT_NO_CULL_Z_OFFSET)
                .withTexture("Sampler0", p_440312_0_)
                .useLightmap()
                .useOverlay()
                .setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING)
                .affectsCrumbling()
                .setOutline(p_440312_1_ ? RenderSetup.OutlineProperty.AFFECTS_OUTLINE : RenderSetup.OutlineProperty.NONE)
                .createRenderSetup();
    ...
    private static final Function<Identifier, RenderType> ITEM_ENTITY_TRANSLUCENT_CULL = Util.memoize(
        p_447156_0_ -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ITEM_ENTITY_TRANSLUCENT_CULL)
                .withTexture("Sampler0", p_447156_0_)
                .setOutputTarget(OutputTarget.ITEM_ENTITY_TARGET)
                .useLightmap()
                .useOverlay()
                .affectsCrumbling()
    ...
    private static final BiFunction<Identifier, Boolean, RenderType> ENTITY_TRANSLUCENT = Util.memoize(
        (p_440166_0_, p_440166_1_) -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ENTITY_TRANSLUCENT)
                .withTexture("Sampler0", p_440166_0_)
                .useLightmap()
                .useOverlay()
                .affectsCrumbling()
                .sortOnUpload()
                .setOutline(p_440166_1_ ? RenderSetup.OutlineProperty.AFFECTS_OUTLINE : RenderSetup.OutlineProperty.NONE)
                .createRenderSetup();
    ...
    private static final BiFunction<Identifier, Boolean, RenderType> ENTITY_TRANSLUCENT_EMISSIVE = Util.memoize(
        (p_444239_0_, p_444239_1_) -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ENTITY_TRANSLUCENT_EMISSIVE)
                .withTexture("Sampler0", p_444239_0_)
                .useOverlay()
                .affectsCrumbling()
                .sortOnUpload()
                .setOutline(p_444239_1_ ? RenderSetup.OutlineProperty.AFFECTS_OUTLINE : RenderSetup.OutlineProperty.NONE)
                .createRenderSetup();
    ...
    private static final Function<Identifier, RenderType> ENTITY_SMOOTH_CUTOUT = Util.memoize(
        p_441588_0_ -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ENTITY_SMOOTH_CUTOUT)
                .withTexture("Sampler0", p_441588_0_)
                .useLightmap()
                .useOverlay()
                .setOutline(RenderSetup.OutlineProperty.AFFECTS_OUTLINE)
                .createRenderSetup();
    ...
    private static final BiFunction<Identifier, Boolean, RenderType> BEACON_BEAM = Util.memoize(
        (p_440053_0_, p_440053_1_) -> {
            RenderSetup rendersetup = RenderSetup.builder(p_440053_1_ ? RenderPipelines.BEACON_BEAM_TRANSLUCENT : RenderPipelines.BEACON_BEAM_OPAQUE)
                .withTexture("Sampler0", p_440053_0_)
                .sortOnUpload()
                .createRenderSetup();
            return RenderType.create("beacon_beam", rendersetup);
        }
    );
    private static final Function<Identifier, RenderType> ENTITY_DECAL = Util.memoize(p_440898_0_ -> {
        RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ENTITY_DECAL).withTexture("Sampler0", p_440898_0_).useLightmap().useOverlay().createRenderSetup();
    ...
    private static final Function<Identifier, RenderType> ENTITY_NO_OUTLINE = Util.memoize(
        p_442890_0_ -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ENTITY_NO_OUTLINE)
                .withTexture("Sampler0", p_442890_0_)
                .useLightmap()
                .useOverlay()
                .sortOnUpload()
                .createRenderSetup();
    ...
    private static final Function<Identifier, RenderType> ENTITY_SHADOW = Util.memoize(
        p_443206_0_ -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.ENTITY_SHADOW)
                .withTexture("Sampler0", p_443206_0_)
                .useLightmap()
                .useOverlay()
                .setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING)
                .createRenderSetup();
    ...
    private static final Function<Identifier, RenderType> DRAGON_EXPLOSION_ALPHA = Util.memoize(
        p_443158_0_ -> {
            RenderSetup rendersetup = RenderSetup.builder(RenderPipelines.DRAGON_EXPLOSION_ALPHA)
                .withTexture("Sampler0", p_443158_0_)
                .setOutline(RenderSetup.OutlineProperty.AFFECTS_OUTLINE)
                .createRenderSetup();
    ...
    private static final Function<Identifier, RenderType> EYES = Util.memoize(
        p_445903_0_ -> RenderType.create("eyes", RenderSetup.builder(RenderPipelines.EYES).withTexture("Sampler0", p_445903_0_).sortOnUpload().createRenderSetup())
    );
    ...
    private static final Function<Identifier, RenderType> CRUMBLING = Util.memoize(
        p_439490_0_ -> RenderType.create(
            "crumbling", RenderSetup.builder(RenderPipelines.CRUMBLING).withTexture("Sampler0", p_439490_0_).sortOnUpload().createRenderSetup()
        )
    );
    private static final Function<Identifier, RenderType> TEXT = Util.memoize(
        p_439567_0_ -> RenderType.create(
            "text", RenderSetup.builder(RenderPipelines.TEXT).withTexture("Sampler0", p_439567_0_).useLightmap().bufferSize(786432).createRenderSetup()
        )
    );
    ...
    private static final Function<Identifier, RenderType> TEXT_INTENSITY = Util.memoize(
        p_446769_0_ -> RenderType.create(
            "text_intensity", RenderSetup.builder(RenderPipelines.TEXT_INTENSITY).withTexture("Sampler0", p_446769_0_).useLightmap().bufferSize(786432).createRenderSetup()
        )
    );
    private static final Function<Identifier, RenderType> TEXT_POLYGON_OFFSET = Util.memoize(
        p_447523_0_ -> RenderType.create(
            "text_polygon_offset", RenderSetup.builder(RenderPipelines.TEXT_POLYGON_OFFSET).withTexture("Sampler0", p_447523_0_).useLightmap().createRenderSetup()
        )
    );
    private static final Function<Identifier, RenderType> TEXT_INTENSITY_POLYGON_OFFSET = Util.memoize(
        p_447449_0_ -> RenderType.create(
            "text_intensity_polygon_offset", RenderSetup.builder(RenderPipelines.TEXT_INTENSITY).withTexture("Sampler0", p_447449_0_).useLightmap().createRenderSetup()
        )
    );
    private static final Function<Identifier, RenderType> TEXT_SEE_THROUGH = Util.memoize(
        p_443447_0_ -> RenderType.create(
            "text_see_through", RenderSetup.builder(RenderPipelines.TEXT_SEE_THROUGH).withTexture("Sampler0", p_443447_0_).useLightmap().createRenderSetup()
        )
    );
    ...
    private static final Function<Identifier, RenderType> TEXT_INTENSITY_SEE_THROUGH = Util.memoize(
        p_446833_0_ -> RenderType.create(
            "text_intensity_see_through", RenderSetup.builder(RenderPipelines.TEXT_INTENSITY_SEE_THROUGH).withTexture("Sampler0", p_446833_0_).useLightmap().createRenderSetup()
        )
    );
    ...
    private static final Function<Identifier, RenderType> BLOCK_SCREEN_EFFECT = Util.memoize(
        p_445485_0_ -> RenderType.create(
            "block_screen_effect", RenderSetup.builder(RenderPipelines.BLOCK_SCREEN_EFFECT).withTexture("Sampler0", p_445485_0_).createRenderSetup()
        )
    );
    private static final Function<Identifier, RenderType> FIRE_SCREEN_EFFECT = Util.memoize(
        p_447636_0_ -> RenderType.create(
            "fire_screen_effect", RenderSetup.builder(RenderPipelines.FIRE_SCREEN_EFFECT).withTexture("Sampler0", p_447636_0_).createRenderSetup()
        )
    );
    ...
    public static RenderType entityCutoutNoCullZOffset(Identifier p_457116_, boolean p_459459_) {
        p_457116_ = getCustomTexture(p_457116_);
    ...
    public static RenderType itemEntityTranslucentCull(Identifier p_452518_) {
        p_452518_ = getCustomTexture(p_452518_);
    ...
    public static RenderType entityTranslucent(Identifier p_460959_, boolean p_458207_) {
        p_460959_ = getCustomTexture(p_460959_);
    ...
    public static RenderType entityTranslucentEmissive(Identifier p_460609_, boolean p_453862_) {
        p_460609_ = getCustomTexture(p_460609_);
    ...
    public static RenderType breezeWind(Identifier p_451678_, float p_451181_, float p_450604_) {
        p_451678_ = getCustomTexture(p_451678_);
    ...
    public static RenderType energySwirl(Identifier p_454362_, float p_457157_, float p_454885_) {
        p_454362_ = getCustomTexture(p_454362_);
        return RenderType.create(
            "energy_swirl",
    ...
    public static RenderType outline(Identifier p_450306_) {
        p_450306_ = getCustomTexture(p_450306_);
    ...
    public static RenderType crumbling(Identifier p_457416_) {
        p_457416_ = getCustomTexture(p_457416_);
        return CRUMBLING.apply(p_457416_);
    }

    public static RenderType text(Identifier p_456274_) {
        return Reflector.ForgeHooksClient.exists() ? ForgeRenderTypes.getText(p_456274_) : TEXT.apply(p_456274_);
    }
    ...
    public static RenderType textIntensity(Identifier p_460070_) {
        return Reflector.ForgeHooksClient.exists() ? ForgeRenderTypes.getTextIntensity(p_460070_) : TEXT_INTENSITY.apply(p_460070_);
    }

    public static RenderType textPolygonOffset(Identifier p_450888_) {
        return Reflector.ForgeHooksClient.exists() ? ForgeRenderTypes.getTextPolygonOffset(p_450888_) : TEXT_POLYGON_OFFSET.apply(p_450888_);
    }

    public static RenderType textIntensityPolygonOffset(Identifier p_457059_) {
        return Reflector.ForgeHooksClient.exists() ? ForgeRenderTypes.getTextIntensityPolygonOffset(p_457059_) : TEXT_INTENSITY_POLYGON_OFFSET.apply(p_457059_);
    }

    public static RenderType textSeeThrough(Identifier p_452096_) {
        return Reflector.ForgeHooksClient.exists() ? ForgeRenderTypes.getTextSeeThrough(p_452096_) : TEXT_SEE_THROUGH.apply(p_452096_);
    }
    ...
    public static RenderType textIntensitySeeThrough(Identifier p_453978_) {
        return Reflector.ForgeHooksClient.exists() ? ForgeRenderTypes.getTextIntensitySeeThrough(p_453978_) : TEXT_INTENSITY_SEE_THROUGH.apply(p_453978_);
    }
    ...
    private static Function<Identifier, RenderType> createWeather(RenderPipeline p_455942_) {
        return Util.memoize(
            loc2In -> RenderType.create(
                "weather", RenderSetup.builder(p_455942_).withTexture("Sampler0", loc2In).setOutputTarget(OutputTarget.WEATHER_TARGET).useLightmap().createRenderSetup()
            )
        );
    }
    ...
    public static RenderType getCustomRenderType(RenderType renderType) {
        Identifier identifier = renderType.getTextureLocation();
        if (identifier == null) {
            return renderType;
        }

        Identifier identifier1 = getCustomTexture(identifier);
        return identifier1 == null ? renderType : renderType.getTextured(identifier);
    }
}
