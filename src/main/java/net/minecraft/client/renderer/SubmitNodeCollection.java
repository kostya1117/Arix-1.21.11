...
public class SubmitNodeCollection implements OrderedSubmitNodeCollector {
    ...
    public String toString() {
        ...
        this.append(stringbuilder, "shadow", this.shadowSubmits);
        this.append(stringbuilder, "flame", this.flameSubmits);
        this.append(stringbuilder, "nameTagOpaque", this.nameTagSubmits.getCountOpaque());
        this.append(stringbuilder, "nameTagTranslucent", this.nameTagSubmits.getCountTranslucent());
        this.append(stringbuilder, "text", this.textSubmits);
        this.append(stringbuilder, "leash", this.leashSubmits);
        this.append(stringbuilder, "block", this.blockSubmits);
        this.append(stringbuilder, "movingBlock", this.movingBlockSubmits);
        this.append(stringbuilder, "blockModel", this.blockModelSubmits);
        this.append(stringbuilder, "item", this.itemSubmits);
        this.append(stringbuilder, "particle", this.particleGroupRenderers);
        this.append(stringbuilder, "modelOpaque", this.modelSubmits.getCountOpaque());
        this.append(stringbuilder, "modelTranslucent", this.modelSubmits.getCountTranslucent());
        this.append(stringbuilder, "customGeom", this.customGeometrySubmits.getCount());
        this.append(stringbuilder, "modelPart", this.modelPartSubmits.getCount());
        return stringbuilder.toString();
    }

    private void append(StringBuilder sb, String name, List list) {
        this.append(sb, name, list.size());
    }
