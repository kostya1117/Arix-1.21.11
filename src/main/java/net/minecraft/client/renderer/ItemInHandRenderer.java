...
public class ItemInHandRenderer {
    ...
    private static final RenderType MAP_BACKGROUND_CHECKERBOARD = RenderTypes.entityCutout(Identifier.withDefaultNamespace("textures/map/map_background_checkerboard.png"));
    ...
    public void renderItem(
        ...
        CustomItems.setRenderOffHand(flag1);
        renderItemHand = true;
...
//        p_109316_.mulPose(Axis.YP.rotationDegrees((p_109318_.getViewYRot(p_109315_) - f3) * 0.1F));
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_109375_)) {
            if (!p_109372_.isScoping()) {
                ...
                if (p_109377_.isEmpty()) {
                    ...
                    int j = flag3 ? 1 : -1;
                    if (p_109372_.isUsingItem() && p_109372_.getUseItemRemainingTicks() > 0 && p_109372_.getUsedItemHand() == p_109375_ && !flag2) {
                        p_109379_.translate(j * -0.4785682F, -0.094387F, 0.05731531F);
                        p_109379_.mulPose(Axis.XP.rotationDegrees(-11.935F));
                        p_109379_.mulPose(Axis.YP.rotationDegrees(j * 65.3F));
                        ...
                        float f8 = f7 / CrossbowItem.getChargeDuration(p_109377_, p_109372_);
                        if (f8 > 1.0F) {
                            f8 = 1.0F;
                        }

                        if (f8 > 0.1F) {
                            float f10 = Mth.sin((f7 - 0.1F) * 1.3F);
                            float f12 = f8 - 0.1F;
                            float f15 = f10 * f12;
                        ...
                        if (flag2 && p_109376_ < 0.001F && flag) {
                            p_109379_.translate(j * -0.641864F, 0.0F, 0.0F);
                            p_109379_.mulPose(Axis.YP.rotationDegrees(j * 10.0F));
                        }
                    }
                        ...
                        if (p_109372_.isUsingItem() && p_109372_.getUseItemRemainingTicks() > 0 && p_109372_.getUsedItemHand() == p_109375_) {
                            ...
                            switch (itemuseanimation) {
                                ...
                                case BLOCK:
                                    if (!(p_109377_.getItem() instanceof ShieldItem)) {
                                        ...
                                        p_109379_.mulPose(Axis.YP.rotationDegrees(i * 13.365F));
                                        p_109379_.mulPose(Axis.ZP.rotationDegrees(i * 78.05F));
                                    }
                                    break;
                                case BOW:
                                    p_109379_.translate(i * -0.2785682F, 0.18344387F, 0.15731531F);
                                    p_109379_.mulPose(Axis.XP.rotationDegrees(-13.935F));
                                    p_109379_.mulPose(Axis.YP.rotationDegrees(i * 35.3F));
                                    ...
                                    break;
                                case TRIDENT:
                                    p_109379_.translate(i * -0.5F, 0.7F, 0.1F);
                                    p_109379_.mulPose(Axis.XP.rotationDegrees(-55.0F));
                                    p_109379_.mulPose(Axis.YP.rotationDegrees(i * 35.3F));
                                    p_109379_.mulPose(Axis.ZP.rotationDegrees(i * -9.785F));
                                    float f2 = p_109377_.getUseDuration(p_109372_) - (p_109372_.getUseItemRemainingTicks() - p_109373_ + 1.0F);
                                    float f3 = f2 / 10.0F;
                                    if (f3 > 1.0F) {
                                        f3 = 1.0F;
                                    }
                                    ...
                                    if (f3 > 0.1F) {
                                        float f13 = Mth.sin((f2 - 0.1F) * 1.3F);
                                        float f5 = f3 - 0.1F;
                                        float f6 = f13 * f5;
                                        p_109379_.translate(f6 * 0.0F, f6 * 0.004F, f6 * 0.0F);
                                    }

                                    p_109379_.translate(0.0F, 0.0F, f3 * 0.2F);
                                    p_109379_.scale(1.0F, 1.0F, 1.0F + f3 * 0.2F);
                                    p_109379_.mulPose(Axis.YN.rotationDegrees(i * 45.0F));
                                    break;
                                case BRUSH:
                                ...
                                case BUNDLE:
                                    ...
                                    break;
                                case SPEAR:
                                    p_109379_.translate(i * 0.56F, -0.52F, -0.72F);
                                    float f4 = p_109377_.getUseDuration(p_109372_) - (p_109372_.getUseItemRemainingTicks() - p_109373_ + 1.0F);
                                    SpearAnimations.firstPersonUse(p_109372_.getTicksSinceLastKineticHitFeedback(p_109373_), p_109379_, f4, humanoidarm, p_109377_);
                            }
                        } else if (p_109372_.isAutoSpinAttack()) {
                            this.applyItemArmTransform(p_109379_, humanoidarm, p_109378_);
                            p_109379_.translate(i * -0.4F, 0.8F, 0.3F);
                            p_109379_.mulPose(Axis.YP.rotationDegrees(i * 65.0F));
                            p_109379_.mulPose(Axis.ZP.rotationDegrees(i * -85.0F));
                        } else {
                            this.applyItemArmTransform(p_109379_, humanoidarm, p_109378_);
                            switch (p_109377_.getSwingAnimation().type()) {
                                ...
                                case WHACK:
                                    ...
                                    break;
                                case STAB:
                                    SpearAnimations.firstPersonAttack(p_109376_, p_109379_, i, humanoidarm);
                            }
                        }
                    }
    ...
    enum HandRenderSelection {
        ...
        HandRenderSelection(final boolean p_172928_, final boolean p_172929_) {
