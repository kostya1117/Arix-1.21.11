...
public class ColorLerper {
    ...
    public static int getLerpedColor(ColorLerper.Type p_406037_, float p_410004_) {
        ...
        if (Config.isCustomColors() && p_406037_ == ColorLerper.Type.SHEEP) {
            j1 = CustomColors.getSheepColors(p_406037_.colors[l], j1);
            k1 = CustomColors.getSheepColors(p_406037_.colors[i1], k1);
        }
    ...
    public enum Type {
        ...
        Type(final int p_408068_, final DyeColor[] p_408212_, final float p_408392_) {
            this.colorDuration = p_408068_;
            this.colorByDye = Maps.newHashMap(
                Arrays.stream(p_408212_).collect(Collectors.toMap(dye2In -> (DyeColor)dye2In, dye3In -> ColorLerper.getModifiedColor(dye3In, p_408392_)))
            );
