...
public abstract class AbstractDebugChart {
    ...
    public void drawChart(GuiGraphics p_300681_, int p_298472_, int p_298870_) {
        ...
        p_300681_.hLine(p_298472_, p_298472_ + p_298870_ - 1, j2 - 60, -1);
        p_300681_.hLine(p_298472_, p_298472_ + p_298870_ - 1, j2 - 1, -1);
        p_300681_.vLine(p_298472_, j2 - 60, j2, -1);
        p_300681_.vLine(p_298472_ + p_298870_ - 1, j2 - 60, j2, -1);
        if (i1 > 0) {
            String s = this.toDisplayString(j) + " min";
            String s1 = this.toDisplayString((double)k2 / i1) + " avg";
            String s2 = this.toDisplayString(k) + " max";
            p_300681_.drawString(this.font, s, p_298472_ + 2, j2 - 60 - 9, -2039584);
            p_300681_.drawCenteredString(this.font, s1, p_298472_ + p_298870_ / 2, j2 - 60 - 9, -2039584);
            p_300681_.drawString(this.font, s2, p_298472_ + p_298870_ - this.font.width(s2) - 2, j2 - 60 - 9, -2039584);
        }
