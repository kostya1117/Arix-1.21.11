...
public class ChatComponent {
    ...
    private void render(final ChatComponent.ChatGraphicsAccess p_454435_, int p_283491_, int p_282406_, boolean p_328818_) {
        ...
        if (!this.isChatHidden()) {
            ...
            if (j > 0) {
                ...
                final int l = Mth.floor((p_283491_ - 40) / f);
                ...
                final int k1 = (int)(9.0 * (d0 + 1.0));
                final int l1 = (int)Math.round(8.0 * (d0 + 1.0) - 4.0 * d0);
                ...
                p_454435_.updatePose(matrix2In -> {
                    matrix2In.scale(f, f);
                    matrix2In.translate(4.0F, 0.0F);
                });
                this.forEachLine(chatcomponent$alphacalculator, (line2In, index2In, alpha2In) -> {
                    int k4 = l - index2In * k1;
                    int l4 = k4 - k1;
                    int i5 = k;
                    if (this.minecraft.options.ofChatBackground == 5) {
                        i5 = this.minecraft.font.width(line2In.content()) - 2;
                    }

                    if (this.minecraft.options.ofChatBackground != 3) {
                        p_454435_.fill(-4, l4, i5 + 4 + 4, k4, ARGB.black(alpha2In * f2));
                    }
                });
                if (i2 > 0L) {
                    p_454435_.fill(-2, l, k + 4, l + 9, ARGB.black(f2));
                }

                int j2 = this.forEachLine(chatcomponent$alphacalculator, new ChatComponent.LineConsumer() {
                    boolean hoveredOverCurrentMessage;

                    @Override
                    public void accept(GuiMessage.Line p_458643_, int p_459782_, float p_460027_) {
                        int k4 = l - p_459782_ * k1;
                        int l4 = k4 - k1;
                        int i5 = k4 - l1;
                        boolean flag = p_454435_.handleMessage(i5, p_460027_ * f1, p_458643_.content());
                        ...
                        if (guimessagetag != null) {
                            p_454435_.handleTag(-4, l4, -2, k4, p_460027_ * f1, guimessagetag);
                            if (guimessagetag.icon() != null) {
                                int j5 = p_458643_.getTagIconLeft(ChatComponent.this.minecraft.font);
                                int k5 = i5 + 9;
                                p_454435_.handleTagIcon(j5, k5, flag1, guimessagetag, guimessagetag.icon());
                            }
                        }
                    }
                });
                if (i2 > 0L) {
                    int k2 = l + 9;
                    Component component = Component.translatable("chat.queue", i2).setStyle(QUEUE_EXPAND_TEXT_STYLE);
                    p_454435_.handleMessage(k2 - 8, 0.5F * f1, component.getVisualOrderText());
                }

                if (p_328818_) {
                    int i4 = j * k1;
                    int j4 = j2 * k1;
                    int l2 = this.chatScrollbarPos * j4 / j - l;
                    int i3 = j4 * j4 / i4;
                    if (i4 != j4) {
                        int j3 = l2 > 0 ? 170 : 96;
                        int k3 = this.newMessageSinceScroll ? 13382451 : 3355562;
                        int l3 = k + 4;
                        p_454435_.fill(l3, -l2, l3 + 2, -l2 - i3, ARGB.color(j3, k3));
                        p_454435_.fill(l3 + 2, -l2, l3 + 1, -l2 - i3, ARGB.color(j3, 13421772));
                    }
                }
    ...
    private int getWidth() {
        ...
        int j = (window.getWidth() - 3) / window.getGuiScale();
    ...
    interface AlphaCalculator {
        ChatComponent.AlphaCalculator FULLY_VISIBLE = lineIn -> 1.0F;

        static ChatComponent.AlphaCalculator timeBased(int p_459736_) {
            return line2In -> {
                int i = p_459736_ - line2In.addedTime();
                double d0 = i / 200.0;
                d0 = 1.0 - d0;
                d0 *= 10.0;
