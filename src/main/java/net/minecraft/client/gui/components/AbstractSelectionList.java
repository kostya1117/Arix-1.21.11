...
public abstract class AbstractSelectionList<E extends AbstractSelectionList.Entry<E>> extends AbstractContainerWidget {
    ...
    public void setSelected( E p_93462_) {
    ...
    @Override
    public void setFocused( GuiEventListener p_265738_) {
        E e = this.getFocused();
    ...
    protected  E nextEntry(ScreenDirection p_265159_, Predicate<E> p_265109_,  E p_265379_) {
