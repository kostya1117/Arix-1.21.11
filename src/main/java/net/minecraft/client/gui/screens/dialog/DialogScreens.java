...
public class DialogScreens {
    ...
    public static <T extends Dialog>  DialogScreen<T> createFromData(T p_406293_,  Screen p_406264_, DialogConnectionAccess p_407821_) {
    ...
    public interface Factory<T extends Dialog> {
        DialogScreen<T> create( Screen p_410616_, T p_408348_, DialogConnectionAccess p_408537_);
    }
}
