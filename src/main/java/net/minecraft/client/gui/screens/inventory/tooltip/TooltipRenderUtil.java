...
public class TooltipRenderUtil {
    ...
    public static void renderTooltipBackground(GuiGraphics p_282666_, int p_281901_, int p_281846_, int p_281559_, int p_283336_,  Identifier p_460335_) {
        int i = p_281901_ - 3 - 9;
        int j = p_281846_ - 3 - 9;
    ...
    private static Identifier getBackgroundSprite( Identifier p_451953_) {
        return p_451953_ == null ? BACKGROUND_SPRITE : p_451953_.withPath(p_362641_ -> "tooltip/" + p_362641_ + "_background");
    }

    private static Identifier getFrameSprite( Identifier p_456901_) {
