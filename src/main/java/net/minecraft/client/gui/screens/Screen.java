...
public abstract class Screen extends AbstractContainerEventHandler implements Renderable {
    ...
    public boolean keyPressed(KeyEvent p_423266_) {
        ...
        if (super.keyPressed(p_423266_)) {
            return true;
        }

        FocusNavigationEvent focusnavigationevent = switch (p_423266_.key()) {
    ...
    protected static void defaultHandleClickEvent(ClickEvent p_407893_, Minecraft p_410530_,  Screen p_407004_) {
        boolean flag = switch (p_407893_) {
            ...
            case ClickEvent.SuggestCommand(String s) -> {
                if (p_407004_ != null) {
                    p_407004_.insertText(s, true);
                }

                yield true;
            }
            case ClickEvent.CopyToClipboard(String s1) -> {
                p_410530_.keyboardHandler.setClipboard(s1);
                yield true;
            }
            default -> {
    ...
    protected static boolean clickUrlAction(Minecraft p_406192_,  Screen p_408543_, URI p_408598_) {
    ...
    public static Screen. NarratableSearchResult findNarratableWidget(List<? extends NarratableEntry> p_169401_,  NarratableEntry p_169402_) {
