...
public class SelectWorldScreen extends Screen {
                ...
                p_357744_ -> {
                    try {
                        ...
                        if (this.list != null && !this.list.children().isEmpty()) {
                            WorldSelectionList.Entry worldselectionlist$entry = (WorldSelectionList.Entry)this.list.children().getFirst();
    ...
    public void updateButtonStatus( LevelSummary p_309997_) {
