...
public class LevelLoadingScreen extends Screen {
    ...
    private static final Object2IntMap<ChunkStatus> COLORS = Util.make(new Object2IntOpenHashMap<>(), mapIn -> {
        mapIn.defaultReturnValue(0);
        mapIn.put(ChunkStatus.EMPTY, 5526612);
        mapIn.put(ChunkStatus.STRUCTURE_STARTS, 10066329);
        mapIn.put(ChunkStatus.STRUCTURE_REFERENCES, 6250897);
        mapIn.put(ChunkStatus.BIOMES, 8434258);
        mapIn.put(ChunkStatus.NOISE, 13750737);
        mapIn.put(ChunkStatus.SURFACE, 7497737);
        mapIn.put(ChunkStatus.CARVERS, 3159410);
        mapIn.put(ChunkStatus.FEATURES, 2213376);
        mapIn.put(ChunkStatus.INITIALIZE_LIGHT, 13421772);
        mapIn.put(ChunkStatus.LIGHT, 16769184);
        mapIn.put(ChunkStatus.SPAWN, 15884384);
