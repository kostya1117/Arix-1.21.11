...
public class TextFieldHelper {
    ...
    public boolean keyPressed(KeyEvent p_426653_) {
        ...
        TextFieldHelper.CursorStep textfieldhelper$cursorstep = p_426653_.hasControlDownWithQuirk() ? TextFieldHelper.CursorStep.WORD : TextFieldHelper.CursorStep.CHARACTER;
