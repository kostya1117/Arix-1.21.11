...
public enum ChatFormatting implements StringRepresentable {
    ...
    ChatFormatting(final String p_126627_, final char p_126628_, final int p_126629_, final @Nullable Integer p_126630_) {
    ...
    ChatFormatting(final String p_126640_, final char p_126641_, final boolean p_126642_, final int p_126643_, final @Nullable Integer p_126644_) {
        this.name = p_126640_;
        this.code = p_126641_;
