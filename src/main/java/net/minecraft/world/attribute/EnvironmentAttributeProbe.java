...
public class EnvironmentAttributeProbe {
    ...
    private final Function<EnvironmentAttribute<?>, EnvironmentAttributeProbe.ValueProbe<?>> valueProbeFactory = attr2In -> new EnvironmentAttributeProbe.ValueProbe<>(
        attr2In
    );
     Level level;
     Vec3 position;
    ...
    public void tick(Level p_458965_, Vec3 p_460324_) {
        ...
        GaussianSampler.sample(
            ...
            (weight2In, biome2In) -> this.biomeInterpolator.accumulate(weight2In, biome2In.value().getAttributes())
        );
    }
    ...
    class ValueProbe<Value> {
        ...
        public String toString() {
            return "last: " + this.lastValue + ", new: " + this.newValue;
        }
    }
}
