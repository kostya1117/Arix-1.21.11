...
public abstract class AbstractFurnaceMenu extends RecipeBookMenu {
    ...
    public RecipeBookMenu.PostPlaceAction handlePlacement(
        ...
        RecipeHolder<AbstractCookingRecipe> recipeholder = (RecipeHolder<AbstractCookingRecipe>)p_366286_;
        ...
        }, 1, 1, List.of(this.getSlot(0)), list, p_364103_, recipeholder, p_366505_, p_361487_);
    }
}
