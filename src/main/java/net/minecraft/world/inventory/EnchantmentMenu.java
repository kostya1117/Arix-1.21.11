    ...
    public boolean clickMenuButton(Player p_39465_, int p_39466_) {
        if (p_39466_ >= 0 && p_39466_ < this.costs.length) {
            ...
            this.access.execute((p_341512_, p_341513_) -> {
                ...
                List<EnchantmentInstance> list = this.getEnchantmentList(p_341512_.registryAccess(), itemstack2, p_39466_, this.costs[p_39466_]);
                if (!list.isEmpty()) {
                    p_39465_.onEnchantmentPerformed(itemstack2, i);
