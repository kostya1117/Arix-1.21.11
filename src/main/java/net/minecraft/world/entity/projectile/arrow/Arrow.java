...
public class Arrow extends AbstractArrow {
    ...
    public Arrow(Level p_453816_, double p_459002_, double p_460176_, double p_450378_, ItemStack p_460785_,  ItemStack p_455384_) {
        super(EntityType.ARROW, p_459002_, p_460176_, p_450378_, p_453816_, p_460785_, p_455384_);
        this.updateColor();
    }

    public Arrow(Level p_455240_, LivingEntity p_451575_, ItemStack p_452605_,  ItemStack p_450609_) {
    ...
    protected void doPostHurtEffects(LivingEntity p_460434_) {
        ...
        potioncontents.forEachEffect(p_445867_2_ -> p_460434_.addEffect(p_445867_2_, entity), f);
    }
