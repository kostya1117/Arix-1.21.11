...
public record VillagerProfession(
    ...
    private static VillagerProfession register(
        Registry<VillagerProfession> p_451838_, ResourceKey<VillagerProfession> p_454597_, ResourceKey<PoiType> p_451406_,  SoundEvent p_456523_
    ) {
