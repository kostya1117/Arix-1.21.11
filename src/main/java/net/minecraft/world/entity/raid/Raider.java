...
public abstract class Raider extends PatrollingMonster {
    ...
    public void setCurrentRaid( Raid p_37852_) {
        this.raid = p_37852_;
    }
    ...
    public  SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_37856_, DifficultyInstance p_37857_, EntitySpawnReason p_368278_,  SpawnGroupData p_37859_
    ) {
    ...
    public class ObtainRaidLeaderBannerGoal<T extends Raider> extends Goal {
        ...
        private boolean cannotPickUpBanner() {
            ...
            if (ItemStack.matches(this.mob.getItemBySlot(EquipmentSlot.HEAD), Raid.getOminousBannerInstance(this.mob.registryAccess().lookupOrThrow(Registries.BANNER_PATTERN)))) {
                return true;
            }
