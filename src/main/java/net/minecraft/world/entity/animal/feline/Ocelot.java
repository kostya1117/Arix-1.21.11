...
public class Ocelot extends Animal {
    ...
    public  Ocelot getBreedOffspring(ServerLevel p_455814_, AgeableMob p_451458_) {
    ...
    public  SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_450717_, DifficultyInstance p_452608_, EntitySpawnReason p_455808_,  SpawnGroupData p_452742_
    ) {
        if (p_452742_ == null) {
