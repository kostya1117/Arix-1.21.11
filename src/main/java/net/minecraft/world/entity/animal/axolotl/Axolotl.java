...
public class Axolotl extends Animal implements Bucketable {
    ...
    @Override
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_149132_, DifficultyInstance p_149133_, EntitySpawnReason p_363665_,  SpawnGroupData p_149135_) {
        boolean flag = false;
    ...
    public enum Variant implements StringRepresentable {
        ...
        Variant(final int p_149239_, final String p_149240_, final boolean p_149241_) {
            this.id = p_149239_;
            this.name = p_149240_;
