...
public class Salmon extends AbstractSchoolingFish {
    ...
    @Override
    public <T>  T get(DataComponentType<? extends T> p_457412_) {
    ...
    public  SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_459412_, DifficultyInstance p_458114_, EntitySpawnReason p_459699_,  SpawnGroupData p_456095_
    ) {
    ...
    public enum Variant implements StringRepresentable {
        ...
        Variant(final String p_455456_, final int p_456977_, final float p_455649_) {
            this.name = p_455456_;
            this.id = p_456977_;
