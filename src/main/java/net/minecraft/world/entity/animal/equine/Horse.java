...
public class Horse extends AbstractHorse {
    ...
    @Override
    public <T>  T get(DataComponentType<? extends T> p_450226_) {
    ...
    @Override
    public  AgeableMob getBreedOffspring(ServerLevel p_460751_, AgeableMob p_451439_) {
    ...
    public  SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_452550_, DifficultyInstance p_450368_, EntitySpawnReason p_460449_,  SpawnGroupData p_450993_
    ) {
