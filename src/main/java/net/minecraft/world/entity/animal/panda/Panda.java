...
public class Panda extends Animal {
    ...
    public enum Gene implements StringRepresentable {
        ...
        Gene(final int p_454562_, final String p_455363_, final boolean p_453158_) {
            this.id = p_454562_;
            this.name = p_455363_;
            ...
            if (this.lookAt == null) {
                ...
                if (this.lookAtType == Player.class) {
                    ...
                    this.lookAt = serverlevel.getNearestEntity(
                        this.mob.level().getEntitiesOfClass(this.lookAtType, this.mob.getBoundingBox().inflate(this.lookDistance, 3.0, this.lookDistance), p_458512_ -> true),
                        this.lookAtContext,
                        this.mob,
                        this.mob.getX(),
                        this.mob.getEyeY(),
