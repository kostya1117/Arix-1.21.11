...
public abstract class AbstractMinecartContainer extends AbstractMinecart implements ContainerEntity {
    ...
    @Override
    public  AbstractContainerMenu createMenu(int p_452235_, Inventory p_452809_, Player p_460397_) {
    ...
    @Override
    public void setContainerLootTable( ResourceKey<LootTable> p_454651_) {
