...
public final class EntityReference<StoredEntityType extends UniquelyIdentifyable> {
    ...
    public static <T extends UniquelyIdentifyable>  EntityReference<T> of( T p_430144_) {
    ...
    private  StoredEntityType resolve( UniquelyIdentifyable p_396749_, Class<StoredEntityType> p_391245_) {
    ...
    public static void store( EntityReference<?> p_409297_, ValueOutput p_406877_, String p_406736_) {
        if (p_409297_ != null) {
    ...
    public static <StoredEntityType extends UniquelyIdentifyable>  StoredEntityType get(
         EntityReference<StoredEntityType> p_392004_, Level p_423373_, Class<StoredEntityType> p_397380_
    ) {
        return p_392004_ != null ? p_392004_.getEntity(p_423373_, p_397380_) : null;
    }

    public static  Entity getEntity( EntityReference<Entity> p_430343_, Level p_426440_) {
        return get(p_430343_, p_426440_, Entity.class);
    }

    public static  LivingEntity getLivingEntity( EntityReference<LivingEntity> p_423502_, Level p_424628_) {
        return get(p_423502_, p_424628_, LivingEntity.class);
    }

    public static  Player getPlayer( EntityReference<Player> p_424138_, Level p_431512_) {
