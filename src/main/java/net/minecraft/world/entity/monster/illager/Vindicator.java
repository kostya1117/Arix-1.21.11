...
public class Vindicator extends AbstractIllager {
    ...
    public  SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_451206_, DifficultyInstance p_457997_, EntitySpawnReason p_455027_,  SpawnGroupData p_455702_
    ) {
    ...
    @Override
    public void setCustomName( Component p_456874_) {
