        ...
        if (!list.isEmpty()) {
            ...
            if (blockhitresult.getType() == HitResult.Type.BLOCK) {
                ...
                if (p_40656_.getFluidState(blockpos).is(FluidTags.WATER)) {
                    ...
                    return InteractionResult.SUCCESS.heldItemTransformedTo(this.turnBottleIntoItem(itemstack, p_40657_, PotionContents.createItemStack(Items.POTION, Potions.WATER)));
                }
            }
