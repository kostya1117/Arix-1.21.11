...
public enum DyeColor implements StringRepresentable {
    ...
    @Deprecated
    public static final Codec<DyeColor> LEGACY_ID_CODEC = Codec.BYTE.xmap(DyeColor::byId, colIn -> (byte)colIn.id);
    ...
    DyeColor(final int p_41046_, final String p_41047_, final int p_41048_, final MapColor p_285297_, final int p_41050_, final int p_41051_) {
        ...
        this.dyesTag = (TagKey<Item>)Reflector.ForgeItemTags_create.call("forge", "dyes/" + p_41047_);
        this.dyedTag = (TagKey<Item>)Reflector.ForgeItemTags_create.call("forge", "dyed/" + p_41047_);
    }
    ...
    public static DyeColor getMixedColor(ServerLevel p_377753_, DyeColor p_378336_, DyeColor p_376650_) {
        ...
        return p_377753_.recipeAccess()
            ...
            .map(holderIn -> holderIn.value().assemble(craftinginput, p_377753_.registryAccess()))
