...
public class RecipeCache {
    ...
    private void insert(CraftingInput p_342978_,  RecipeHolder<CraftingRecipe> p_330177_) {
    ...
    record Entry(NonNullList<ItemStack> key, int width, int height,  RecipeHolder<CraftingRecipe> value) {
