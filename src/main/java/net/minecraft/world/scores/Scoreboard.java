...
public class Scoreboard {
    ...
    public ScoreAccess getOrCreatePlayerScore(final ScoreHolder p_310827_, final Objective p_312875_, boolean p_310024_) {
        ...
        return new ScoreAccess() {
            ...
            @Override
            public void display( Component p_309551_) {
            ...
            @Override
            public void numberFormatOverride( NumberFormat p_312257_) {
    ...
    public void setDisplayObjective(DisplaySlot p_297926_,  Objective p_83419_) {
