...
public class BiomeManager {
    ...
    private static double getFiddledDistance(long p_186680_, int p_186681_, int p_186682_, int p_186683_, double p_186684_, double p_186685_, double p_186686_) {
        long i = p_186680_;
        i = LinearCongruentialGenerator.next(i, p_186681_);
        i = LinearCongruentialGenerator.next(i, p_186682_);
        i = LinearCongruentialGenerator.next(i, p_186683_);
        i = LinearCongruentialGenerator.next(i, p_186681_);
        i = LinearCongruentialGenerator.next(i, p_186682_);
        i = LinearCongruentialGenerator.next(i, p_186683_);
        double d0 = getFiddle(i);
        i = LinearCongruentialGenerator.next(i, p_186680_);
