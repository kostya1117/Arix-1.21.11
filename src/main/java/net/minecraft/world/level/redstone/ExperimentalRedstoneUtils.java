...
public class ExperimentalRedstoneUtils {
    public static  Orientation initialOrientation(Level p_360797_,  Direction p_367898_,  Direction p_368279_) {
    ...
    public static  Orientation withFront( Orientation p_367198_, Direction p_365285_) {
