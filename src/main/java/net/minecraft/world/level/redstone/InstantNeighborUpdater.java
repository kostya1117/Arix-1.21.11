...
public class InstantNeighborUpdater implements NeighborUpdater {
    ...
    @Override
    public void neighborChanged(BlockPos p_230751_, Block p_230752_,  Orientation p_367804_) {
    ...
    @Override
    public void neighborChanged(BlockState p_230745_, BlockPos p_230746_, Block p_230747_,  Orientation p_369588_, boolean p_230749_) {
