...
public interface NeighborUpdater {
    ...
    void neighborChanged(BlockPos p_230781_, Block p_230782_,  Orientation p_360748_);

    void neighborChanged(BlockState p_366525_, BlockPos p_230785_, Block p_230786_,  Orientation p_367786_, boolean p_366743_);

    default void updateNeighborsAtExceptFromFacing(BlockPos p_230788_, Block p_230789_,  Direction p_230790_,  Orientation p_361940_) {
    ...
    static void executeUpdate(Level p_230764_, BlockState p_230765_, BlockPos p_230766_, Block p_230767_,  Orientation p_364742_, boolean p_230769_) {
        try {
