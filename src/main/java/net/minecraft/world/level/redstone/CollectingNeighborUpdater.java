...
public class CollectingNeighborUpdater implements NeighborUpdater {
    ...
    public void setDebugListener( Consumer<BlockPos> p_425764_) {
    ...
    @Override
    public void neighborChanged(BlockPos p_230653_, Block p_230654_,  Orientation p_364159_) {
        this.addAndRun(p_230653_, new CollectingNeighborUpdater.SimpleNeighborUpdate(p_230653_, p_230654_, p_364159_));
    }

    @Override
    public void neighborChanged(BlockState p_230647_, BlockPos p_230648_, Block p_230649_,  Orientation p_367539_, boolean p_230651_) {
    ...
    @Override
    public void updateNeighborsAtExceptFromFacing(BlockPos p_230657_, Block p_230658_,  Direction p_230659_,  Orientation p_368385_) {
    ...
    static final class MultiNeighborUpdate implements CollectingNeighborUpdater.NeighborUpdates {
        ...
        MultiNeighborUpdate(BlockPos p_230697_, Block p_230698_,  Orientation p_369746_,  Direction p_230699_) {
