...
public class EndCityPieces {
    ...
    static final EndCityPieces.SectionGenerator TOWER_GENERATOR = new EndCityPieces.SectionGenerator() {
        ...
        public boolean generate(
            ...
            EndCityPieces.EndCityPiece endcitypieces$endcitypiece = p_227467_;
            endcitypieces$endcitypiece = EndCityPieces.addHelper(
                p_227469_,
                EndCityPieces.addPiece(
                    p_227465_,
                    endcitypieces$endcitypiece,
                    new BlockPos(3 + p_227470_.nextInt(2), -3, 3 + p_227470_.nextInt(2)),
                    "tower_base",
                    rotation,
                    true
                )
            ...
            endcitypieces$endcitypiece = EndCityPieces.addHelper(
                p_227469_, EndCityPieces.addPiece(p_227465_, endcitypieces$endcitypiece, new BlockPos(0, 7, 0), "tower_piece", rotation, true)
            );
            EndCityPieces.EndCityPiece endcitypieces$endcitypiece1 = p_227470_.nextInt(3) == 0 ? endcitypieces$endcitypiece : null;
            int i = 1 + p_227470_.nextInt(3);

            for (int j = 0; j < i; j++) {
                endcitypieces$endcitypiece = EndCityPieces.addHelper(
                    p_227469_, EndCityPieces.addPiece(p_227465_, endcitypieces$endcitypiece, new BlockPos(0, 4, 0), "tower_piece", rotation, true)
                );
            ...
            if (endcitypieces$endcitypiece1 != null) {
                ...
                endcitypieces$endcitypiece = EndCityPieces.addHelper(
                    p_227469_, EndCityPieces.addPiece(p_227465_, endcitypieces$endcitypiece, new BlockPos(-1, 4, -1), "tower_top", rotation, true)
                );
            } else {
                if (p_227466_ != 7) {
                    return EndCityPieces.recursiveChildren(p_227465_, EndCityPieces.FAT_TOWER_GENERATOR, p_227466_ + 1, endcitypieces$endcitypiece, null, p_227469_, p_227470_);
                }
