...
public class NoiseRouterData {
    ...
    private static DensityFunction slide(
        ...
        DensityFunction densityfunction = p_224444_;
        ...
        densityfunction = DensityFunctions.lerp(densityfunction1, p_224449_, densityfunction);
        DensityFunction densityfunction2 = DensityFunctions.yClampedGradient(p_224445_ + p_224450_, p_224445_ + p_224451_, 0.0, 1.0);
        return DensityFunctions.lerp(densityfunction2, p_224452_, densityfunction);
    }
