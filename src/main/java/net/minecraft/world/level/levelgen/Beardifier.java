...
public class Beardifier implements DensityFunctions.BeardifierOrMarker {
    ...
    private static BoundingBox includeBoundingBox( BoundingBox p_426589_, BoundingBox p_427502_) {
        return p_426589_ == null ? p_427502_ : BoundingBox.encapsulating(p_426589_, p_427502_);
    }

    @VisibleForTesting
    public Beardifier(List<Beardifier.Rigid> p_430256_, List<JigsawJunction> p_428173_,  BoundingBox p_428923_) {
