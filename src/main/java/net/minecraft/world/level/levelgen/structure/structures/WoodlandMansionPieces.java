        ...
        private void createRoof(
            ...
            for (int i = 0; i < p_230106_.height; i++) {
                for (int j = 0; j < p_230106_.width; j++) {
                    BlockPos blockpos = p_230104_;
                    blockpos = blockpos.relative(p_230105_.rotate(Direction.SOUTH), 8 + (i - this.startY) * 8);
                    blockpos = blockpos.relative(p_230105_.rotate(Direction.EAST), (j - this.startX) * 8);
                    ...
                    if (WoodlandMansionPieces.MansionGrid.isHouse(p_230106_, j, i) && !flag) {
                        p_230103_.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "roof", blockpos.above(3), p_230105_));
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(p_230106_, j + 1, i)) {
                            BlockPos blockpos1 = blockpos.relative(p_230105_.rotate(Direction.EAST), 6);
                        ...
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(p_230106_, j - 1, i)) {
                            BlockPos blockpos5 = blockpos.relative(p_230105_.rotate(Direction.EAST), 0);
                        ...
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(p_230106_, j, i - 1)) {
                            BlockPos blockpos6 = blockpos.relative(p_230105_.rotate(Direction.WEST), 1);
                            p_230103_.add(
                                new WoodlandMansionPieces.WoodlandMansionPiece(
                        ...
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(p_230106_, j, i + 1)) {
                            BlockPos blockpos7 = blockpos.relative(p_230105_.rotate(Direction.EAST), 6);
            ...
            if (p_230107_ != null) {
                for (int k = 0; k < p_230106_.height; k++) {
                    for (int i1 = 0; i1 < p_230106_.width; i1++) {
                        BlockPos blockpos3 = p_230104_;
                        blockpos3 = blockpos3.relative(p_230105_.rotate(Direction.SOUTH), 8 + (k - this.startY) * 8);
            ...
            for (int l = 0; l < p_230106_.height; l++) {
                for (int j1 = 0; j1 < p_230106_.width; j1++) {
                    BlockPos blockpos4 = p_230104_;
                    blockpos4 = blockpos4.relative(p_230105_.rotate(Direction.SOUTH), 8 + (l - this.startY) * 8);
