...
public class SimpleRegionStorage implements AutoCloseable {
    ...
    public CompoundTag upgradeChunkTag(CompoundTag p_457269_, int p_452563_,  CompoundTag p_454370_) {
    ...
    public static void injectDatafixingContext(CompoundTag p_460950_,  CompoundTag p_456449_) {
        if (p_456449_ != null) {
