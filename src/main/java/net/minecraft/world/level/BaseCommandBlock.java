...
public abstract class BaseCommandBlock {
    ...
    private BaseCommandBlock. CloseableCommandBlockSource createSource(ServerLevel p_459376_) {
    ...
    public void setCustomName( Component p_327944_) {
        this.customName = p_327944_;
    }

    public abstract void onUpdated(ServerLevel p_453381_);

    public void setLastOutput( Component p_45434_) {
