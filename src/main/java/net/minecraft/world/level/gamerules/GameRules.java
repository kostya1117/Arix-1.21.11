...
public class GameRules {
    ...
    public <T> void set(GameRule<T> p_457739_, T p_450832_,  MinecraftServer p_453139_) {
    ...
    public void setAll(GameRules p_456658_,  MinecraftServer p_455033_) {
        this.setAll(p_456658_.rules, p_455033_);
    }

    public void setAll(GameRuleMap p_452499_,  MinecraftServer p_450469_) {
        p_452499_.keySet().forEach(p_455800_ -> this.setFromOther(p_452499_, (GameRule<?>)p_455800_, p_450469_));
    }

    private <T> void setFromOther(GameRuleMap p_450857_, GameRule<T> p_459006_,  MinecraftServer p_456260_) {
