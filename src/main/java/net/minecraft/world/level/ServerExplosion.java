...
public class ServerExplosion implements Explosion {
    ...
    public ServerExplosion(
        ServerLevel p_363225_,
         Entity p_367780_,
         DamageSource p_367845_,
         ExplosionDamageCalculator p_361628_,
        Vec3 p_364875_,
        float p_361128_,
        boolean p_362786_,
    ...
    private ExplosionDamageCalculator makeDamageCalculator( Entity p_362997_) {
        return p_362997_ == null ? EXPLOSION_DAMAGE_CALCULATOR : new EntityBasedExplosionDamageCalculator(p_362997_);
    }
