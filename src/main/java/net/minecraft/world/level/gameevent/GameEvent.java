...
public record GameEvent(int notificationRadius) {
    ...
    public record Context( Entity sourceEntity,  BlockState affectedState) {
        public static GameEvent.Context of( Entity p_223718_) {
            return new GameEvent.Context(p_223718_, null);
        }

        public static GameEvent.Context of( BlockState p_223723_) {
            return new GameEvent.Context(null, p_223723_);
        }

        public static GameEvent.Context of( Entity p_223720_,  BlockState p_223721_) {
