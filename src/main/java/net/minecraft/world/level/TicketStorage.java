...
public class TicketStorage extends SavedData {
    ...
    public void setLoadingChunkUpdatedListener(TicketStorage. ChunkUpdated p_395306_) {
        this.loadingChunkUpdatedListener = p_395306_;
    }

    public void setSimulationChunkUpdatedListener(TicketStorage. ChunkUpdated p_394573_) {
    ...
    private static  Ticket getLowestTicket( List<Ticket> p_394356_, boolean p_394342_) {
        if (p_394356_ == null) {
            return null;
        }
    ...
    private boolean canTicketExpire(ChunkMap p_426585_, Ticket p_428731_, long p_427492_) {
        ...
        if (p_428731_.getType().canExpireIfUnloaded()) {
            return true;
        }
    ...
    public void removeTicketIf(TicketStorage.TicketPredicate p_428518_,  Long2ObjectOpenHashMap<List<Ticket>> p_396309_) {
