...
public interface Spawner {
    ...
    static void appendHoverText( TypedEntityData<BlockEntityType<?>> p_429083_, Consumer<Component> p_394104_, String p_310819_) {
    ...
    static  Component getSpawnEntityDisplayName( TypedEntityData<BlockEntityType<?>> p_427322_, String p_309907_) {
