...
public interface CollisionGetter extends BlockGetter {
    ...
    default boolean noCollision( Entity p_361913_, AABB p_361643_, boolean p_370219_) {
    ...
    default boolean noBlockCollision( Entity p_299893_, AABB p_300925_) {
        return this.noBlockCollision(p_299893_, p_300925_, false);
    }

    default boolean noBlockCollision( Entity p_459096_, AABB p_451303_, boolean p_460573_) {
    ...
    default boolean noEntityCollision( Entity p_453592_, AABB p_458559_) {
        return this.getEntityCollisions(p_453592_, p_458559_).isEmpty();
    }

    default boolean noBorderCollision( Entity p_453697_, AABB p_455970_) {
        if (p_453697_ == null) {
            return true;
        }
    ...
    default Iterable<VoxelShape> getPreMoveCollisions( Entity p_409681_, AABB p_406401_, Vec3 p_408346_) {
    ...
    default Iterable<VoxelShape> getBlockAndLiquidCollisions( Entity p_367195_, AABB p_366686_) {
