...
public class BeaconBlockEntity extends BlockEntity implements MenuProvider, Nameable, BeaconBeamOwner {
    ...
    static  Holder<MobEffect> filterEffect( Holder<MobEffect> p_330198_) {
    ...
    public static void tick(Level p_155108_, BlockPos p_155109_, BlockState p_155110_, BeaconBlockEntity p_155111_) {
        ...
        if (p_155111_.lastCheckY < j) {
            ...
            p_155111_.lastCheckY = blockpos.getY() - 1;
        } else {
    ...
    private static void applyEffects(
        Level p_155098_, BlockPos p_155099_, int p_155100_,  Holder<MobEffect> p_329363_,  Holder<MobEffect> p_332048_
    ) {
    ...
    private static void storeEffect(ValueOutput p_407172_, String p_297212_,  Holder<MobEffect> p_329692_) {
        if (p_329692_ != null) {
