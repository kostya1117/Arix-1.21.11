...
public abstract class BlockEntity extends CapabilityProvider.BlockEntities implements IForgeBlockEntity, DebugValueSource, Cullable {
    ...
    protected void loadAdditional(ValueInput p_409136_) {
        if (this.getCapabilities() != null) {
            p_409136_.read("ForgeCaps", CompoundTag.CODEC).ifPresent(caps -> this.deserializeCaps(p_409136_.lookup(), caps));
        }
    }
    ...
    protected void saveAdditional(ValueOutput p_407573_) {
        if (this.getCapabilities() != null && this.level != null) {
            p_407573_.storeNullable("ForgeCaps", CompoundTag.CODEC, this.serializeCaps(p_407573_));
        }
    }
