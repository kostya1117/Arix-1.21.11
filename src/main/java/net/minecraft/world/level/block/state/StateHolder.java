...
//
//public abstract class StateHolder<O, S> implements FastMapStateHolder<S> {
...
//        public String apply( Entry<Property<?>, Comparable<?>> p_61155_) {
//            if (p_61155_ == null) {
//                return "<NULL>";
//            } else {
...
public abstract class StateHolder<O, S> implements FastMapStateHolder<S> {
    ...
    private int ferritecore_globalTableIndex;
    private FastMap<S> ferritecore_globalTable;
    private Reference2ObjectMap<Property<?>, Comparable<?>> values;
    private Map<Property<?>, S[]> neighbours;
    protected final MapCodec<S> propertiesCodec;

    protected StateHolder(O p_61117_, Reference2ObjectMap<Property<?>, Comparable<?>> p_331170_, MapCodec<S> p_61119_) {
        this.owner = p_61117_;
        this.values = p_331170_;
        this.propertiesCodec = p_61119_;
    }
    ...
    public void replacePropertyMap(Reference2ObjectMap<Property<?>, Comparable<?>> newMap) {
        // This cast is incorrect and will be removed by FerriteMixinConfig#postApply when the field type is changed to
        // Reference2ObjectMap
        values = (Reference2ObjectMap<Property<?>, Comparable<?>>) newMap;
    }
