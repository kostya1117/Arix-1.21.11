...
public enum Direction implements StringRepresentable {
    ...
    @Deprecated
    public static final Codec<Direction> LEGACY_ID_CODEC = Codec.BYTE.xmap(Direction::from3DDataValue, dirIn -> (byte)dirIn.get3DDataValue());
    @Deprecated
    public static final Codec<Direction> LEGACY_ID_CODEC_2D = Codec.BYTE.xmap(Direction::from2DDataValue, dirIn -> (byte)dirIn.get2DDataValue());
    ...
    public static  Direction getNearest(int p_367360_, int p_362027_, int p_368517_,  Direction p_368118_) {
    ...
    public static  Direction getNearest(Vec3i p_365890_,  Direction p_366391_) {
    ...
    public enum AxisDirection {
        ...
        AxisDirection(final int p_122538_, final String p_122539_) {
            this.step = p_122538_;
            this.name = p_122539_;
        }
    ...
    public enum Plane implements Iterable<Direction>, Predicate<Direction> {
        ...
        Plane(final Direction[] p_122555_, final Direction.Axis[] p_122556_) {
