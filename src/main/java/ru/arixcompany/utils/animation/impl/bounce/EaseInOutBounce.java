...
public class EaseInOutBounce extends Animation {
    private static final double N1 = 7.5625;
    private static final double D1 = 2.75;

    public EaseInOutBounce(int duration, double endPoint) {
        super(duration, endPoint);
    }

    public EaseInOutBounce(int duration, double endPoint, Direction direction) {
