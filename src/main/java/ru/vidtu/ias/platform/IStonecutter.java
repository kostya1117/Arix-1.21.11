...
public final class IStonecutter {
     ...
     */
    //? if fabric {
    public static final Path GAME_DIRECTORY = Arix.gameDirectory.toPath();
    //?} elif neoforge {
     ...
     */
    //? if fabric {
    public static final Path CONFIG_DIRECTORY = new File(Minecraft.getInstance().gameDirectory, "arix/alt").toPath();
    //?} elif neoforge {
