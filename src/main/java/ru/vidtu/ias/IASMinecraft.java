    ...
    public static CompletableFuture<Void> account(Minecraft minecraft, LoginData data) {
        ...
        return CompletableFuture.runAsync(() -> {
            ...
            minecraft.execute(() -> {
                ...
                //? if >=1.21.10
                minecraft.setServices(services);
                minecraft.setUser(user);
                minecraft.setProfileFuture(profile);
                minecraft.setUserApiService(apiService);
                minecraft.setUserPropertiesFuture(propertiesFuture);
                minecraft.setPlayerSocialManager(social);
                minecraft.setTelemetryManager(telemetry);
                minecraft.setProfileKeyPairManager(keyPair);
                minecraft.setReportingContext(reporting);
