...
public final class EnchantmentAttributesEmulation1_20_6 implements IMinecraft {
    ...
    @EventHandler
    public static void init(EventWorldTick eventWorldTick) {
        if (ProtocolTranslator.getTargetVersion().newerThan(ProtocolVersion.v1_20_5)) {
            return;
        }
        ClientLevel clientLevel = eventWorldTick.getClientLevel();
