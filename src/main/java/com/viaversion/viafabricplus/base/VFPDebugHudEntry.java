...
import com.viaversion.viafabricplus.injection.mixin.base.access.MixinChunkTracker;
import com.viaversion.viafabricplus.injection.mixin.base.access.MixinRakSessionCodec;
...
public final class VFPDebugHudEntry implements DebugScreenEntry {
    ...
    public void display(final DebugScreenDisplayer lines, @Nullable final Level world, @Nullable final LevelChunk clientChunk, @Nullable final LevelChunk chunk) {
        ...
        if (chunkTracker != null) {
            final IChunkTracker mixinChunkTracker = new MixinChunkTracker(chunkTracker);
        ...
        if (connection.getChannel() instanceof RakClientChannel rakClientChannel) {
            ...
            if (rakSessionCodec != null) {
                final IRakSessionCodec mixinRakSessionCodec = new MixinRakSessionCodec(rakSessionCodec);
