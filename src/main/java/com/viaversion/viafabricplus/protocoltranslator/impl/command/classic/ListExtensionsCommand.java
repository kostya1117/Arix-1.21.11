...
import com.viaversion.viafabricplus.injection.mixin.base.access.MixinExtensionProtocolMetadataStorage;
...
public final class ListExtensionsCommand implements VFPSubCommand {
    ...
    public boolean execute(ViaCommandSender sender, String[] args) {
        ...
        final ExtensionProtocolMetadataStorage storage = getUser().get(ExtensionProtocolMetadataStorage.class);
        final IExtensionProtocolMetadataStorage accessor = new MixinExtensionProtocolMetadataStorage(storage);

        accessor.viaFabricPlus$getServerExtensions().forEach((extension, version) -> {
