...
public abstract class GpuBuffer implements AutoCloseable {
    ...
    public GpuBufferSlice slice(long offsetIn, long lengthIn, Object data) {
        GpuBufferSlice gpubufferslice = this.slice(offsetIn, lengthIn);
        gpubufferslice.setData(data);
