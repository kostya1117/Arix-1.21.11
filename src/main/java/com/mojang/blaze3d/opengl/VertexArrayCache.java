...
public abstract class VertexArrayCache {
    ...
    public static class Emulated extends VertexArrayCache {
        ...
        public static void setupCombinedAttributes(VertexFormat p_396813_, boolean p_397111_) {
            ...
            for (int j = 0; j < list.size(); j++) {
                ...
                if (k >= 0) {
                    ...
                    switch (vertexformatelement.usage()) {
                        ...
                        case UV:
                            if (vertexformatelement.type() == VertexFormatElement.Type.FLOAT) {
                                GlStateManager._vertexAttribPointer(
                                    ...
                                    false,
                                    i,
                                    p_396813_.getOffset(vertexformatelement)
                                );
                            } else {
                                GlStateManager._vertexAttribIPointer(
                                    k, vertexformatelement.count(), GlConst.toGl(vertexformatelement.type()), i, p_396813_.getOffset(vertexformatelement)
                                );
                            }
                            break;
                        case NORMAL:
                        case COLOR:
                            GlStateManager._vertexAttribPointer(
                                k, vertexformatelement.count(), GlConst.toGl(vertexformatelement.type()), true, i, p_396813_.getOffset(vertexformatelement)
                            );
                    }
                }
            }

            if (Config.isShaders() && p_396813_.getIntegerSize() == 18) {
                ShadersRender.setupArrayPointersVbo(p_397111_);
            }
        }
    }
                ...
                if (p_391840_ != null) {
                    ...
                    for (int j = 0; j < list.size(); j++) {
                        ...
                        if (k >= 0) {
                                ...
                                case UV:
                                    if (vertexformatelement.type() == VertexFormatElement.Type.FLOAT) {
                                        ...
                                        ARBVertexAttribBinding.glVertexAttribIFormat(
                                            k, vertexformatelement.count(), GlConst.toGl(vertexformatelement.type()), p_391319_.getOffset(vertexformatelement)
                                        );
                                    }
                                    break;
                                case NORMAL:
                            ...
                            ARBVertexAttribBinding.glVertexAttribBinding(k, 0);
                        }
                    }
                }
