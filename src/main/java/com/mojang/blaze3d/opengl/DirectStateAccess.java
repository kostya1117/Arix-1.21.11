...
public abstract class DirectStateAccess {
    ...
    abstract  ByteBuffer mapBufferRange(int p_407884_, long p_452014_, long p_457474_, int p_409299_, @GpuBuffer.Usage int p_406257_);
    ...
    abstract void texParameter(int var1, int var2, int var3);

    abstract void texParameter(int var1, int var2, float var3);

    abstract boolean isEmulated();
    ...
    static class Core extends DirectStateAccess {
        ...
        @Override
         ByteBuffer mapBufferRange(int p_406865_, long p_452102_, long p_452408_, int p_408097_, @GpuBuffer.Usage int p_405964_) {
        ...
        @Override
        void texParameter(int texId, int pname, int param) {
            ARBDirectStateAccess.glTextureParameteri(texId, pname, param);
        }

        @Override
        void texParameter(int texId, int pname, float param) {
            ARBDirectStateAccess.glTextureParameterf(texId, pname, param);
        }
    ...
    static class Emulated extends DirectStateAccess {
        ...
        @Override
         ByteBuffer mapBufferRange(int p_408912_, long p_451693_, long p_453585_, int p_407523_, @GpuBuffer.Usage int p_406540_) {
        ...
        public void bindFrameBufferTextures(int p_397405_, int p_395460_, int p_393875_, int p_393114_, int p_397703_) {
            int i = p_397703_ == 0 ? 36009 : p_397703_;
        ...
        void texParameter(int texId, int pname, int param) {
            ...
            GlStateManager._texParameter(3553, pname, param);
        }

        @Override
        void texParameter(int texId, int pname, float param) {
            GlStateManager._bindTexture(texId);
            GlStateManager.texParameter(3553, pname, param);
        }
