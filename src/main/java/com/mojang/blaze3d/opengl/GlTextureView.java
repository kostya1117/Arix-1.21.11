...
public class GlTextureView extends GpuTextureView {
    ...
    public int getFbo(DirectStateAccess p_457836_,  GpuTexture p_459514_) {
    ...
    private int createFbo(DirectStateAccess p_453035_, int p_453170_) {
        ...
        RenderSystem.getGlDevice().debugLabels().applyLabelFramebuffer(i, this.texture().getLabel() + "/" + i);
        return i;
    }
    ...
    public String toString() {
        ...
        return this.texture() + ", mips: " + this.baseMipLevel() + "-" + this.mipLevels() + ", fbo: " + s;
    }
}
