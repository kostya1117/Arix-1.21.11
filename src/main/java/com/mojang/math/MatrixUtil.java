...
public class MatrixUtil {
    ...
    private static GivensParameters approxGivensQuat(float p_276275_, float p_276276_, float p_276282_) {
        ...
        float f1 = p_276276_;
        return G * f1 * f1 < f * f ? GivensParameters.fromUnnormalized(f1, f) : PI_4;
    }
    ...
    public static Triple<Quaternionf, Vector3f, Quaternionf> svdDecompose(Matrix3f p_253947_) {
        ...
        Matrix3f matrix3f1 = matrix3f;
        Matrix3f matrix3f2 = p_253947_.rotate(quaternionf);
        Quaternionf quaternionf1 = new Quaternionf();
        ...
        Matrix3f matrix3f3 = givensparameters.aroundZ(matrix3f1);
        ...
        Matrix3f matrix3f4 = givensparameters.aroundY(matrix3f1);
        ...
        Matrix3f matrix3f5 = givensparameters.aroundX(matrix3f1);
