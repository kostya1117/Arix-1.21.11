...
public final class Transformation {
    ...
    public Transformation( Matrix4fc p_393211_) {
        if (p_393211_ == null) {
    ...
    public Transformation( Vector3fc p_455816_,  Quaternionfc p_452471_,  Vector3fc p_458390_,  Quaternionfc p_454607_) {
    ...
    private static Matrix4f compose(
         Vector3fc p_456190_,  Quaternionfc p_457962_,  Vector3fc p_451996_,  Quaternionfc p_453189_
    ) {
