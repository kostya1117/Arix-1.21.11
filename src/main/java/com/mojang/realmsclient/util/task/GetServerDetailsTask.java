...
public class GetServerDetailsTask extends LongRunningTask {
    ...
    public void run() {
        ...
        if (realmsjoininformation.address() == null) {
            ...
            Screen screen = flag ? this.resourcePackDownloadConfirmationScreen(realmsjoininformation, generatePackId(this.server), this::connectScreen) : this.connectScreen(realmsjoininformation);
            setScreen(screen);
        }
    }
    ...
    private CompletableFuture<?> scheduleResourcePackDownload(RealmsJoinInformation p_407280_, UUID p_312305_) {
        try {
            ...
            if (p_407280_.resourcePackHash() == null) {
